...
var fAS=_mz(z,'c-list-select',['bind:__l',2,'bindclick',1,'uI',2,'uP',3],[],e,s,gg)
_(o0R,fAS)
}
o0R.wxXCkey=1
o0R.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-products-search/search-categories.wxss'] = setCssToHead([],undefined,{path:"./components/c-products-search/search-categories.wxss"});
}