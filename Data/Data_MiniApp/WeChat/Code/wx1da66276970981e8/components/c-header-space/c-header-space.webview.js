...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-header-space/c-header-space.wxss'] = setCssToHead([],undefined,{path:"./components/c-header-space/c-header-space.wxss"});
}