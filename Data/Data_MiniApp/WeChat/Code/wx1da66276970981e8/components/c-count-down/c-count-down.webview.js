...
Z([[6],[[7],[3,'$slots']],[3,'d']])
Z([3,'u-count-down__text data-v-2f38f4db'])
Z([a,[[7],[3,'a']]])
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-count-down/c-count-down.wxss'] = setCssToHead(["wx-scroll-view.",[1],"data-v-2f38f4db,wx-swiper-item.",[1],"data-v-2f38f4db,wx-view.",[1],"data-v-2f38f4db{display:flex;flex-direction:column;flex-shrink:0;flex-grow:0;flex-basis:auto;align-items:stretch;align-content:flex-start}\n.",[1],"u-count-down__text.",[1],"data-v-2f38f4db{color:#606266;font-size:15px;line-height:22px}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./components/c-count-down/c-count-down.wxss:1:1)",{path:"./components/c-count-down/c-count-down.wxss"});
}