...
var tCK=_mz(z,'u-navbar',['bind:__l',1,'bindleftClick',1,'uI',2,'uP',3],[],e,s,gg)
_(aBK,tCK)
}
aBK.wxXCkey=1
aBK.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-navbar/c-navbar.wxss'] = setCssToHead([],undefined,{path:"./components/c-navbar/c-navbar.wxss"});
}