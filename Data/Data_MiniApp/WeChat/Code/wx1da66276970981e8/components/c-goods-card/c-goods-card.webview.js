...
var xCH=_mz(z,'goods-item',['bind:__l',2,'binddetail',1,'uI',2,'uP',3],[],e,s,gg)
_(oBH,xCH)
}
oBH.wxXCkey=1
oBH.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-goods-card/c-goods-card.wxss'] = setCssToHead([],undefined,{path:"./components/c-goods-card/c-goods-card.wxss"});
}