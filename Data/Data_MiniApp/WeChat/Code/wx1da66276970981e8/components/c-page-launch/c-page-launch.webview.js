...
var cXK=_mz(z,'u-loading-page',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(fWK,cXK)
}
fWK.wxXCkey=1
fWK.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-page-launch/c-page-launch.wxss'] = setCssToHead([],undefined,{path:"./components/c-page-launch/c-page-launch.wxss"});
}