...
var oJT=_mz(z,'view',['bindtap',0,'class',1,'style',1],[],e,s,gg)
var cKT=_v()
_(oJT,cKT)
if(_oz(z,3,e,s,gg)){cKT.wxVkey=1
var oLT=_mz(z,'u-icon',['bind:__l',4,'class',1,'uI',2,'uP',3],[],e,s,gg)
_(cKT,oLT)
}
cKT.wxXCkey=1
cKT.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/c-toggle-button/c-toggle-button.wxss'] = setCssToHead([".",[1],"c-toggle-button.",[1],"data-v-2c663144{position:relative;padding:0}\n.",[1],"c-toggle-button.",[1],"no-padding.",[1],"data-v-2c663144{padding:0}\n.",[1],"c-toggle-button.",[1],"inline.",[1],"data-v-2c663144{display:inline-block}\n",],undefined,{path:"./components/c-toggle-button/c-toggle-button.wxss"});
}