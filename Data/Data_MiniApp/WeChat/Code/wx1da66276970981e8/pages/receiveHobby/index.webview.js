...
var bUFD=_v()
_(r,bUFD)
if(_oz(z,0,e,s,gg)){bUFD.wxVkey=1
var oVFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(bUFD,oVFD)
}
bUFD.wxXCkey=1
bUFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/receiveHobby/index.wxss'] = setCssToHead([],undefined,{path:"./pages/receiveHobby/index.wxss"});
}