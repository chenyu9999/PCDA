...
var oXFD=_v()
_(r,oXFD)
if(_oz(z,0,e,s,gg)){oXFD.wxVkey=1
var fYFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oXFD,fYFD)
}
oXFD.wxXCkey=1
oXFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/relaAgreement/index.wxss'] = setCssToHead([],undefined,{path:"./pages/relaAgreement/index.wxss"});
}