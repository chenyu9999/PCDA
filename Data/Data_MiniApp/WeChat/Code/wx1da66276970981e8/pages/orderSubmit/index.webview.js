...
var oXED=_v()
_(r,oXED)
if(_oz(z,0,e,s,gg)){oXED.wxVkey=1
var lYED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oXED,lYED)
}
oXED.wxXCkey=1
oXED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/orderSubmit/index.wxss'] = setCssToHead([],undefined,{path:"./pages/orderSubmit/index.wxss"});
}