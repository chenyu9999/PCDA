...
var e8FD=_mz(z,'c-film-card',['bind:__l',3,'bindgoShare',1,'uI',2,'uP',3],[],l5FD,o4FD,gg)
_(a6FD,e8FD)
return a6FD
}
o2FD.wxXCkey=4
_2z(z,1,c3FD,e,s,gg,o2FD,'item','index','a')
var b9FD=_mz(z,'c-film-share',['bind:__l',7,'class',1,'uI',2,'uR',3],[],e,s,gg)
_(h1FD,b9FD)
_(r,h1FD)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/search2/film-list.wxss'] = setCssToHead([],undefined,{path:"./pages/search2/film-list.wxss"});
}