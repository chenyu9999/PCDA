...
Z([[7],[3,'a']])
Z([3,'d'])
Z([[2,'+'],[1,'margin-top:'],[[6],[[7],[3,'item']],[3,'e']]])
Z([[6],[[7],[3,'item']],[3,'c']])
Z([3,'__l'])
Z([[6],[[7],[3,'item']],[3,'a']])
Z([[6],[[7],[3,'item']],[3,'b']])
...
var cGGD=_n('view')
_rz(z,cGGD,'style',3,cDGD,fCGD,gg)
var oHGD=_v()
_(cGGD,oHGD)
if(_oz(z,4,cDGD,fCGD,gg)){oHGD.wxVkey=1
var lIGD=_mz(z,'goods-item',['bind:__l',5,'binddetail',1,'uI',2,'uP',3],[],cDGD,fCGD,gg)
_(oHGD,lIGD)
}
oHGD.wxXCkey=1
oHGD.wxXCkey=3
...
xAGD.wxXCkey=4
_2z(z,1,oBGD,e,s,gg,xAGD,'item','index','d')
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/search2/hotel-list.wxss'] = setCssToHead([],undefined,{path:"./pages/search2/hotel-list.wxss"});
}