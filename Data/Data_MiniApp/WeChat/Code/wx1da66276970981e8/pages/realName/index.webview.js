...
var aRFD=_v()
_(r,aRFD)
if(_oz(z,0,e,s,gg)){aRFD.wxVkey=1
var tSFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(aRFD,tSFD)
}
aRFD.wxXCkey=1
aRFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/realName/index.wxss'] = setCssToHead([],undefined,{path:"./pages/realName/index.wxss"});
}