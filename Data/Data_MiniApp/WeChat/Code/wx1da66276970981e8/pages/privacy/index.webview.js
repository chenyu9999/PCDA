...
var eFFD=_v()
_(r,eFFD)
if(_oz(z,0,e,s,gg)){eFFD.wxVkey=1
var bGFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(eFFD,bGFD)
}
eFFD.wxXCkey=1
eFFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/privacy/index.wxss'] = setCssToHead([],undefined,{path:"./pages/privacy/index.wxss"});
}