...
var oNCB=_v()
_(r,oNCB)
if(_oz(z,0,e,s,gg)){oNCB.wxVkey=1
var lOCB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oNCB,lOCB)
}
oNCB.wxXCkey=1
oNCB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/accredit/index.wxss'] = setCssToHead([],undefined,{path:"./pages/accredit/index.wxss"});
}