...
Z([3,'display:flex;flex-direction:row;align-items:center;flex-wrap:wrap;justify-content:space-around;margin-top:10rpx'])
Z([3,'item'])
Z([[7],[3,'a']])
Z([3,'a'])
Z([3,'__l'])
...
var e4CD=_n('view')
_rz(z,e4CD,'style',0,e,s,gg)
var b5CD=_v()
_(e4CD,b5CD)
var o6CD=function(o8CD,x7CD,f9CD,gg){
var hADD=_mz(z,'brick-safety-goods-item',['bind:__l',4,'uI',1,'uP',2],[],o8CD,x7CD,gg)
_(f9CD,hADD)
return f9CD
}
b5CD.wxXCkey=4
_2z(z,2,o6CD,e,s,gg,b5CD,'item','index','a')
_(r,e4CD)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/marketing/brick-safety-goods.wxss'] = setCssToHead([],undefined,{path:"./pages/marketing/brick-safety-goods.wxss"});
}