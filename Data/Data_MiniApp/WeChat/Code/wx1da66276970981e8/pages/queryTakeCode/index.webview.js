...
var cOFD=_v()
_(r,cOFD)
if(_oz(z,0,e,s,gg)){cOFD.wxVkey=1
var oPFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(cOFD,oPFD)
}
cOFD.wxXCkey=1
cOFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/queryTakeCode/index.wxss'] = setCssToHead([],undefined,{path:"./pages/queryTakeCode/index.wxss"});
}