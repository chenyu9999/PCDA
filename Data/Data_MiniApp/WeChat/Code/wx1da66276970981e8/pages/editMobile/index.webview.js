...
var x1RB=_v()
_(r,x1RB)
if(_oz(z,0,e,s,gg)){x1RB.wxVkey=1
var o2RB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(x1RB,o2RB)
}
x1RB.wxXCkey=1
x1RB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/editMobile/index.wxss'] = setCssToHead([],undefined,{path:"./pages/editMobile/index.wxss"});
}