...
var oRRB=_v()
_(r,oRRB)
if(_oz(z,0,e,s,gg)){oRRB.wxVkey=1
var cSRB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oRRB,cSRB)
}
oRRB.wxXCkey=1
oRRB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/deliveryAddress/index.wxss'] = setCssToHead([],undefined,{path:"./pages/deliveryAddress/index.wxss"});
}