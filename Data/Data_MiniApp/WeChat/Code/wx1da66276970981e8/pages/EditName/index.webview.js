...
var oHCB=_v()
_(r,oHCB)
if(_oz(z,0,e,s,gg)){oHCB.wxVkey=1
var fICB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oHCB,fICB)
}
oHCB.wxXCkey=1
oHCB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/EditName/index.wxss'] = setCssToHead([],undefined,{path:"./pages/EditName/index.wxss"});
}