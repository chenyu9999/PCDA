...
var aLED=_v()
_(r,aLED)
if(_oz(z,0,e,s,gg)){aLED.wxVkey=1
var tMED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(aLED,tMED)
}
aLED.wxXCkey=1
aLED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/openDoor/index.wxss'] = setCssToHead([],undefined,{path:"./pages/openDoor/index.wxss"});
}