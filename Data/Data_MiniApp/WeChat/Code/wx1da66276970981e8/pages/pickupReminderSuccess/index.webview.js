...
var lCFD=_v()
_(r,lCFD)
if(_oz(z,0,e,s,gg)){lCFD.wxVkey=1
var aDFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(lCFD,aDFD)
}
lCFD.wxXCkey=1
lCFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/pickupReminderSuccess/index.wxss'] = setCssToHead([],undefined,{path:"./pages/pickupReminderSuccess/index.wxss"});
}