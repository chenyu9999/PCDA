...
var cX5B=_mz(z,'head-search',['bind:__l',1,'class',1,'uI',2],[],e,s,gg)
_(fW5B,cX5B)
_(r,fW5B)
var oV5B=_v()
_(r,oV5B)
if(_oz(z,4,e,s,gg)){oV5B.wxVkey=1
var hY5B=_mz(z,'view',['class',5,'style',1],[],e,s,gg)
_(oV5B,hY5B)
}
oV5B.wxXCkey=1
return r
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/entry/home/components/head-view.wxss'] = setCssToHead([".",[1],"head-wrap.",[1],"data-v-628fd93c{width:100vw;height:125px;background-color:#ffcfcb;background-size:cover;flex-direction:column;background-repeat:no-repeat;background-color:$page-bg-color;position:relative;overflow:hidden;display:flex}\n",],undefined,{path:"./pages/entry/home/components/head-view.wxss"});
}