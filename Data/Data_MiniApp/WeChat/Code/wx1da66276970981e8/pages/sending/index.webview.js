...
var e0KD=_v()
_(r,e0KD)
if(_oz(z,0,e,s,gg)){e0KD.wxVkey=1
var bALD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(e0KD,bALD)
}
e0KD.wxXCkey=1
e0KD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/sending/index.wxss'] = setCssToHead([],undefined,{path:"./pages/sending/index.wxss"});
}