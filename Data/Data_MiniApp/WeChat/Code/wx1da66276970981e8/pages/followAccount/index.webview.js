...
var oFRC=_v()
_(r,oFRC)
if(_oz(z,0,e,s,gg)){oFRC.wxVkey=1
var fGRC=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oFRC,fGRC)
}
oFRC.wxXCkey=1
oFRC.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/followAccount/index.wxss'] = setCssToHead([],undefined,{path:"./pages/followAccount/index.wxss"});
}