...
var bOED=_v()
_(r,bOED)
if(_oz(z,0,e,s,gg)){bOED.wxVkey=1
var oPED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(bOED,oPED)
}
bOED.wxXCkey=1
bOED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/openDoorDetail/index.wxss'] = setCssToHead([],undefined,{path:"./pages/openDoorDetail/index.wxss"});
}