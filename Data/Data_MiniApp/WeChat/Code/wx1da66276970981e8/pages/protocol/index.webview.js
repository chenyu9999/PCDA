...
var xIFD=_v()
_(r,xIFD)
if(_oz(z,0,e,s,gg)){xIFD.wxVkey=1
var oJFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(xIFD,oJFD)
}
xIFD.wxXCkey=1
xIFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/protocol/index.wxss'] = setCssToHead([],undefined,{path:"./pages/protocol/index.wxss"});
}