...
var eRQB=_v()
_(r,eRQB)
if(_oz(z,0,e,s,gg)){eRQB.wxVkey=1
var bSQB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(eRQB,bSQB)
}
eRQB.wxXCkey=1
eRQB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/customService/index.wxss'] = setCssToHead([],undefined,{path:"./pages/customService/index.wxss"});
}