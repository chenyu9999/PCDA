...
var oPGB=_v()
_(bOGB,oPGB)
if(_oz(z,0,e,s,gg)){oPGB.wxVkey=1
var xQGB=_n('web-view')
_rz(z,xQGB,'src',1,e,s,gg)
_(oPGB,xQGB)
}
else{oPGB.wxVkey=2
var oRGB=_n('view')
_rz(z,oRGB,'style',2,e,s,gg)
var fSGB=_v()
_(oRGB,fSGB)
if(_oz(z,3,e,s,gg)){fSGB.wxVkey=1
var cTGB=_mz(z,'u-empty',['bind:__l',4,'uI',1,'uP',2],[],e,s,gg)
_(fSGB,cTGB)
}
fSGB.wxXCkey=1
fSGB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/common/customer-service/index.wxss'] = setCssToHead([],undefined,{path:"./pages/common/customer-service/index.wxss"});
}