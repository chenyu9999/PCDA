...
var x1DB=_v()
_(r,x1DB)
if(_oz(z,0,e,s,gg)){x1DB.wxVkey=1
var o2DB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(x1DB,o2DB)
}
x1DB.wxXCkey=1
x1DB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/choosePackage/index.wxss'] = setCssToHead([],undefined,{path:"./pages/choosePackage/index.wxss"});
}