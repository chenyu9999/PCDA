...
var o48C=_v()
_(r,o48C)
if(_oz(z,0,e,s,gg)){o48C.wxVkey=1
var x58C=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(o48C,x58C)
}
o48C.wxXCkey=1
o48C.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/login/index.wxss'] = setCssToHead([],undefined,{path:"./pages/login/index.wxss"});
}