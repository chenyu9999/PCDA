...
var hKCB=_v()
_(r,hKCB)
if(_oz(z,0,e,s,gg)){hKCB.wxVkey=1
var oLCB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(hKCB,oLCB)
}
hKCB.wxXCkey=1
hKCB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/EditPhone/index.wxss'] = setCssToHead([],undefined,{path:"./pages/EditPhone/index.wxss"});
}