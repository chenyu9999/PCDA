...
var bCRC=_v()
_(r,bCRC)
if(_oz(z,0,e,s,gg)){bCRC.wxVkey=1
var oDRC=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(bCRC,oDRC)
}
bCRC.wxXCkey=1
bCRC.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/express/index.wxss'] = setCssToHead([],undefined,{path:"./pages/express/index.wxss"});
}