...
var t1ED=_v()
_(r,t1ED)
if(_oz(z,0,e,s,gg)){t1ED.wxVkey=1
var e2ED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(t1ED,e2ED)
}
t1ED.wxXCkey=1
t1ED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/othersTake/index.wxss'] = setCssToHead([],undefined,{path:"./pages/othersTake/index.wxss"});
}