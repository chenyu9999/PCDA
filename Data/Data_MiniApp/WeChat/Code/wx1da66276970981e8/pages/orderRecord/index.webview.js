...
var hUED=_v()
_(r,hUED)
if(_oz(z,0,e,s,gg)){hUED.wxVkey=1
var oVED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(hUED,oVED)
}
hUED.wxXCkey=1
hUED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/orderRecord/index.wxss'] = setCssToHead([],undefined,{path:"./pages/orderRecord/index.wxss"});
}