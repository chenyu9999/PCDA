...
var cIED=_v()
_(r,cIED)
if(_oz(z,0,e,s,gg)){cIED.wxVkey=1
var oJED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(cIED,oJED)
}
cIED.wxXCkey=1
cIED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/nearStore/index.wxss'] = setCssToHead([],undefined,{path:"./pages/nearStore/index.wxss"});
}