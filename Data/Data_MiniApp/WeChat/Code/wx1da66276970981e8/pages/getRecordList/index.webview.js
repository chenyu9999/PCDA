...
var hIRC=_v()
_(r,hIRC)
if(_oz(z,0,e,s,gg)){hIRC.wxVkey=1
var oJRC=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(hIRC,oJRC)
}
hIRC.wxXCkey=1
hIRC.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/getRecordList/index.wxss'] = setCssToHead([],undefined,{path:"./pages/getRecordList/index.wxss"});
}