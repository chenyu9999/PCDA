...
var f78C=_v()
_(r,f78C)
if(_oz(z,0,e,s,gg)){f78C.wxVkey=1
var c88C=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(f78C,c88C)
}
f78C.wxXCkey=1
f78C.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/loginout/index.wxss'] = setCssToHead([],undefined,{path:"./pages/loginout/index.wxss"});
}