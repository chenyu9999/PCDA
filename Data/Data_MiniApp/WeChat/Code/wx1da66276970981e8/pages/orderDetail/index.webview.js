...
var oRED=_v()
_(r,oRED)
if(_oz(z,0,e,s,gg)){oRED.wxVkey=1
var fSED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(oRED,fSED)
}
oRED.wxXCkey=1
oRED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/orderDetail/index.wxss'] = setCssToHead([],undefined,{path:"./pages/orderDetail/index.wxss"});
}