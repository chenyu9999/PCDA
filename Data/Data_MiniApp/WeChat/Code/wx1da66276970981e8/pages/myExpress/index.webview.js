...
var cFED=_v()
_(r,cFED)
if(_oz(z,0,e,s,gg)){cFED.wxVkey=1
var hGED=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(cFED,hGED)
}
cFED.wxXCkey=1
cFED.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/myExpress/index.wxss'] = setCssToHead([],undefined,{path:"./pages/myExpress/index.wxss"});
}