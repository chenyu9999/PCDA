...
var cLFD=_v()
_(r,cLFD)
if(_oz(z,0,e,s,gg)){cLFD.wxVkey=1
var hMFD=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(cLFD,hMFD)
}
cLFD.wxXCkey=1
cLFD.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/queryOrder/index.wxss'] = setCssToHead([],undefined,{path:"./pages/queryOrder/index.wxss"});
}