...
var hCKB=_v()
_(r,hCKB)
if(_oz(z,0,e,s,gg)){hCKB.wxVkey=1
var oDKB=_mz(z,'c-page-launch',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(hCKB,oDKB)
}
hCKB.wxXCkey=1
hCKB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/complaint/index.wxss'] = setCssToHead([],undefined,{path:"./pages/complaint/index.wxss"});
}