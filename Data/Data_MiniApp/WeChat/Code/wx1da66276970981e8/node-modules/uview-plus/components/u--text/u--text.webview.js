...
var a6W=_mz(z,'uv-text',['bind:__l',1,'uI',1,'uP',2],[],e,s,gg)
_(l5W,a6W)
}
l5W.wxXCkey=1
l5W.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['node-modules/uview-plus/components/u--text/u--text.wxss'] = setCssToHead([],undefined,{path:"./node-modules/uview-plus/components/u--text/u--text.wxss"});
}