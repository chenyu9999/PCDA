...
Z([[6],[[7],[3,'$slots']],[3,'d']])
Z([3,'u-count-down__text data-v-68231eb2'])
Z([a,[[7],[3,'a']]])
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['node-modules/uview-plus/components/u-count-down/u-count-down.wxss'] = setCssToHead(["wx-scroll-view.",[1],"data-v-68231eb2,wx-swiper-item.",[1],"data-v-68231eb2,wx-view.",[1],"data-v-68231eb2{display:flex;flex-direction:column;flex-shrink:0;flex-grow:0;flex-basis:auto;align-items:stretch;align-content:flex-start}\n.",[1],"u-count-down__text.",[1],"data-v-68231eb2{color:#606266;font-size:15px;line-height:22px}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./node-modules/uview-plus/components/u-count-down/u-count-down.wxss:1:1)",{path:"./node-modules/uview-plus/components/u-count-down/u-count-down.wxss"});
}