...
var bUW=_mz(z,'uv-form',['bind:__l',1,'class',1,'uI',2,'uP',3,'uR',4,'uS',5],[],e,s,gg)
var oVW=_n('slot')
_(bUW,oVW)
_(eTW,bUW)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['node-modules/uview-plus/components/u--form/u--form.wxss'] = setCssToHead([],undefined,{path:"./node-modules/uview-plus/components/u--form/u--form.wxss"});
}