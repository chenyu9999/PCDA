...
var o87=_mz(z,'u-transition',['bind:__l',1,'bindclick',1,'class',2,'uI',3,'uP',4,'uS',5],[],e,s,gg)
var l97=_n('slot')
_(o87,l97)
_(c77,o87)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['node-modules/uview-plus/components/u-overlay/u-overlay.wxss'] = setCssToHead(["wx-scroll-view.",[1],"data-v-b3464260,wx-swiper-item.",[1],"data-v-b3464260,wx-view.",[1],"data-v-b3464260{display:flex;flex-direction:column;flex-shrink:0;flex-grow:0;flex-basis:auto;align-items:stretch;align-content:flex-start}\n.",[1],"u-overlay.",[1],"data-v-b3464260{position:fixed;top:0;left:0;width:100%;height:100%;background-color:rgba(0,0,0,.7)}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./node-modules/uview-plus/components/u-overlay/u-overlay.wxss:1:1)",{path:"./node-modules/uview-plus/components/u-overlay/u-overlay.wxss"});
}