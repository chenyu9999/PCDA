...
Z([3,'u-sticky data-v-a2c39d76'])
Z([[7],[3,'b']])
Z([[7],[3,'c']])
Z([3,'u-sticky__content data-v-a2c39d76'])
Z([[7],[3,'a']])
...
var eTAB=_mz(z,'view',['class',0,'id',1,'style',1],[],e,s,gg)
var bUAB=_mz(z,'view',['class',3,'style',1],[],e,s,gg)
var oVAB=_n('slot')
_(bUAB,oVAB)
_(eTAB,bUAB)
_(r,eTAB)
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['node-modules/uview-plus/components/u-sticky/u-sticky.wxss'] = setCssToHead([".",[1],"u-sticky.",[1],"data-v-a2c39d76{position:sticky}\n",],undefined,{path:"./node-modules/uview-plus/components/u-sticky/u-sticky.wxss"});
}