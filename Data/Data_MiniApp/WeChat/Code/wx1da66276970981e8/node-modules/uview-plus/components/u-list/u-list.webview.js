...
var xA5=_mz(z,'scroll-view',['bindscroll',0,'bindscrolltolower',1,'bindscrolltoupper',1,'class',2,'enableBackToTop',3,'lowerThreshold',4,'scrollIntoView',5,'scrollTop',6,'scrollWithAnimation',7,'scrollY',8,'showScrollbar',9,'style',10,'upperThreshold',11],[],e,s,gg)
var oB5=_n('view')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['node-modules/uview-plus/components/u-list/u-list.wxss'] = setCssToHead(["wx-scroll-view.",[1],"data-v-4f1a360a,wx-swiper-item.",[1],"data-v-4f1a360a,wx-view.",[1],"data-v-4f1a360a{display:flex;flex-direction:column;flex-shrink:0;flex-grow:0;flex-basis:auto;align-items:stretch;align-content:flex-start}\n.",[1],"u-list.",[1],"data-v-4f1a360a{display:flex;flex-direction:column}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./node-modules/uview-plus/components/u-list/u-list.wxss:1:1)",{path:"./node-modules/uview-plus/components/u-list/u-list.wxss"});
}