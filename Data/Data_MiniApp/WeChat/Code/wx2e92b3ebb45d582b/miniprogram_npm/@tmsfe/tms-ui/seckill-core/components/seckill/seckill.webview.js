...
var oVVB=_n('seckill')
_rz(z,oVVB,'activityControl',0,e,s,gg)
_(r,oVVB)
var xWVB=_n('follow')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/seckill-core/components/seckill/seckill.wxss'] = setCssToHead([],undefined,{path:"./miniprogram_npm/@tmsfe/tms-ui/seckill-core/components/seckill/seckill.wxss"});
}