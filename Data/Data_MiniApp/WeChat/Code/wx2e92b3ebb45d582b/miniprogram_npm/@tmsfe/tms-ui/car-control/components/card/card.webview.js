...
var z=gz$gwx_XC_8_1()
var bGP=e_[x[0]].i
_ai(bGP,x[1],e_,x[0],2,2)
_ai(bGP,x[2],e_,x[0],3,2)
_ai(bGP,x[3],e_,x[0],4,2)
var oHP=_v()
_(r,oHP)
...
else _w(xIP,x[0],6,14)
var cLP=_mz(z,'pin-modal',['id',2,'show',1],[],e,s,gg)
_(r,cLP)
bGP.pop()
bGP.pop()
bGP.pop()
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/car-control/components/card/card.wxss'] = setCssToHead([[2,"./miniprogram_npm/@tmsfe/tms-ui/car-control/components/card/template-sinan/template-sinan.wxss"],[2,"./miniprogram_npm/@tmsfe/tms-ui/car-control/components/card/template-carindex/template-carindex.wxss"],[2,"./miniprogram_npm/@tmsfe/tms-ui/car-control/components/card/template-sinanhome/template-sinanhome.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./miniprogram_npm/@tmsfe/tms-ui/car-control/components/card/card.wxss:1:3314)",{path:"./miniprogram_npm/@tmsfe/tms-ui/car-control/components/card/card.wxss"});
}