...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/shaker/shaker.wxml'] = [$gwx_XC_53, './miniprogram_npm/@tmsfe/tms-ui/shaker/shaker.wxml'];else __wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/shaker/shaker.wxml'] = $gwx_XC_53( './miniprogram_npm/@tmsfe/tms-ui/shaker/shaker.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/shaker/shaker.wxss'] = setCssToHead([],undefined,{path:"./miniprogram_npm/@tmsfe/tms-ui/shaker/shaker.wxss"});
}