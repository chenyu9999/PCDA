...
var oPJ=_mz(z,'view',['bindtap',0,'catch:touchmove',1,'class',1],[],e,s,gg)
var fQJ=_n('slot')
_(oPJ,fQJ)
_(r,oPJ)
return r
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_36();	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/mask/mask.wxml'] = [$gwx_XC_36, './miniprogram_npm/@tmsfe/tms-ui/mask/mask.wxml'];else __wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/mask/mask.wxml'] = $gwx_XC_36( './miniprogram_npm/@tmsfe/tms-ui/mask/mask.wxml' );
	;__wxRoute = "miniprogram_npm/@tmsfe/tms-ui/mask/mask";__wxRouteBegin = true;__wxAppCurrentFile__="miniprogram_npm/@tmsfe/tms-ui/mask/mask.js";define("miniprogram_npm/@tmsfe/tms-ui/mask/mask.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({externalClasses:["container-class"],properties:{show:{type:Boolean},effect:{type:String,value:""},hideDelay:{type:Number},hideOnTap:{type:Boolean,value:!0},iOSBlur:Boolean,center:{type:Boolean,value:!0}},data:{},methods:{handleMaskTap:function(){this.data.hideOnTap&&(this.setData({show:!1}),this.triggerEvent("hide"))},touchmove:function(){}}});
},{isPage:false,isComponent:true,currentFile:'miniprogram_npm/@tmsfe/tms-ui/mask/mask.js'});require("miniprogram_npm/@tmsfe/tms-ui/mask/mask.js");