...
var bMBB=_mz(z,'choose-address',['bind:addrchange',0,'bind:save-addr-fail',1,'bind:save-addr-start',1,'class',2,'customStyle',3],[],e,s,gg)
_(r,bMBB)
return r
}
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/luckydraw/delivery.wxml'] = [$gwx_XC_32, './miniprogram_npm/@tmsfe/tms-ui/luckydraw/delivery.wxml'];else __wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/luckydraw/delivery.wxml'] = $gwx_XC_32( './miniprogram_npm/@tmsfe/tms-ui/luckydraw/delivery.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram_npm/@tmsfe/tms-ui/luckydraw/delivery.wxss'] = setCssToHead([],undefined,{path:"./miniprogram_npm/@tmsfe/tms-ui/luckydraw/delivery.wxss"});
}