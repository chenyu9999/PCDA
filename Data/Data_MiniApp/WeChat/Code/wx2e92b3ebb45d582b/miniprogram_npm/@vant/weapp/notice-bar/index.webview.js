...
var oP0B=_mz(z,'view',['bind:tap',1,'class',1,'style',2],[],e,s,gg)
var lQ0B=_v()
_(oP0B,lQ0B)
if(_oz(z,4,e,s,gg)){lQ0B.wxVkey=1
var tS0B=_mz(z,'van-icon',['class',5,'name',1,'size',2],[],e,s,gg)
_(lQ0B,tS0B)
}
else{lQ0B.wxVkey=2
var eT0B=_n('slot')
_rz(z,eT0B,'name',8,e,s,gg)
_(lQ0B,eT0B)
}
var bU0B=_n('view')
_rz(z,bU0B,'class',9,e,s,gg)
var oV0B=_mz(z,'view',['animation',10,'class',1],[],e,s,gg)
var oX0B=_oz(z,12,e,s,gg)
_(oV0B,oX0B)
var xW0B=_v()
_(oV0B,xW0B)
if(_oz(z,13,e,s,gg)){xW0B.wxVkey=1
var fY0B=_n('slot')
_(xW0B,fY0B)
}
xW0B.wxXCkey=1
...
var aR0B=_v()
_(oP0B,aR0B)
if(_oz(z,14,e,s,gg)){aR0B.wxVkey=1
var cZ0B=_mz(z,'van-icon',['catch:tap',15,'class',1,'name',2],[],e,s,gg)
_(aR0B,cZ0B)
}
else if(_oz(z,18,e,s,gg)){aR0B.wxVkey=2
var h10B=_mz(z,'navigator',['openType',19,'url',1],[],e,s,gg)
var o20B=_mz(z,'van-icon',['class',21,'name',1],[],e,s,gg)
_(h10B,o20B)
_(aR0B,h10B)
}
else{aR0B.wxVkey=3
var c30B=_n('slot')
_rz(z,c30B,'name',23,e,s,gg)
_(aR0B,c30B)
}
lQ0B.wxXCkey=1
lQ0B.wxXCkey=3
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_93();
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/notice-bar/index.wxml'] = [$gwx_XC_93, './miniprogram_npm/@vant/weapp/notice-bar/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/notice-bar/index.wxml'] = $gwx_XC_93( './miniprogram_npm/@vant/weapp/notice-bar/index.wxml' );
