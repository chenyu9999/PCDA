...
var oJU=_mz(z,'van-icon',['class',22,'customClass',1,'dot',2,'info',3,'name',4],[],e,s,gg)
_(bIU,oJU)
}
else{bIU.wxVkey=2
var xKU=_n('slot')
_rz(z,xKU,'name',27,e,s,gg)
_(bIU,xKU)
}
bIU.wxXCkey=1
bIU.wxXCkey=3
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var i=require("../common/component"),n=require("../mixins/button"),e=require("../mixins/link");(0,i.VantComponent)({classes:["icon-class","text-class"],mixins:[e.link,n.button],props:{text:String,dot:Boolean,info:String,icon:String,disabled:Boolean,loading:Boolean},methods:{onClick:function(i){this.$emit("click",i.detail),this.jumpLink()}}});
},{isPage:false,isComponent:true,currentFile:'miniprogram_npm/@vant/weapp/goods-action-icon/index.js'});require("miniprogram_npm/@vant/weapp/goods-action-icon/index.js");