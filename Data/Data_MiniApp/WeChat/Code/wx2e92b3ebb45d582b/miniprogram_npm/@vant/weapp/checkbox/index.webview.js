...
var cL3B=_mz(z,'view',['bindtap',2,'class',1],[],e,s,gg)
var hM3B=_n('slot')
_(cL3B,hM3B)
_(oJ3B,cL3B)
}
var oN3B=_mz(z,'view',['bindtap',4,'class',1],[],e,s,gg)
var cO3B=_v()
_(oN3B,cO3B)
if(_oz(z,6,e,s,gg)){cO3B.wxVkey=1
var oP3B=_n('slot')
_rz(z,oP3B,'name',7,e,s,gg)
_(cO3B,oP3B)
}
else{cO3B.wxVkey=2
var lQ3B=_mz(z,'van-icon',['class',8,'customClass',1,'customStyle',2,'name',3,'size',4,'style',5],[],e,s,gg)
_(cO3B,lQ3B)
}
cO3B.wxXCkey=1
cO3B.wxXCkey=3
...
var fK3B=_v()
_(xI3B,fK3B)
if(_oz(z,14,e,s,gg)){fK3B.wxVkey=1
var aR3B=_mz(z,'view',['bindtap',15,'class',1],[],e,s,gg)
var tS3B=_n('slot')
_(aR3B,tS3B)
_(fK3B,aR3B)
}
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/checkbox/index.wxml'] = [$gwx_XC_67, './miniprogram_npm/@vant/weapp/checkbox/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/checkbox/index.wxml'] = $gwx_XC_67( './miniprogram_npm/@vant/weapp/checkbox/index.wxml' );
