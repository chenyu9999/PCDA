...
var aT2=_mz(z,'view',['bindtouchcancel',0,'bindtouchend',1,'bindtouchstart',1,'capture-bind:touchmove',2,'catchtap',3,'catchtouchmove',4,'class',5,'data-key',6],[],e,s,gg)
var tU2=_n('view')
_rz(z,tU2,'style',8,e,s,gg)
var eV2=_v()
_(tU2,eV2)
if(_oz(z,9,e,s,gg)){eV2.wxVkey=1
var oX2=_mz(z,'view',['catch:tap',10,'class',1,'data-key',2],[],e,s,gg)
var xY2=_n('slot')
_rz(z,xY2,'name',13,e,s,gg)
_(oX2,xY2)
_(eV2,oX2)
}
var oZ2=_n('slot')
...
var bW2=_v()
_(tU2,bW2)
if(_oz(z,14,e,s,gg)){bW2.wxVkey=1
var f12=_mz(z,'view',['catch:tap',15,'class',1,'data-key',2],[],e,s,gg)
var c22=_n('slot')
_rz(z,c22,'name',18,e,s,gg)
_(f12,c22)
_(bW2,f12)
}
eV2.wxXCkey=1
