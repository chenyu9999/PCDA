...
var a0S=_mz(z,'van-popup',['bind:after-enter',1,'bind:after-leave',1,'bind:close',2,'bind:enter',3,'bind:leave',4,'closeOnClickOverlay',5,'customStyle',6,'duration',7,'overlay',8,'overlayStyle',9,'position',10,'show',11],[],e,s,gg)
var tAT=_v()
_(a0S,tAT)
var eBT=function(oDT,bCT,xET,gg){
var fGT=_mz(z,'van-cell',['clickable',-1,'bind:tap',15,'class',1,'data-option',2,'icon',3],[],oDT,bCT,gg)
var cHT=_v()
_(fGT,cHT)
if(_oz(z,19,oDT,bCT,gg)){cHT.wxVkey=1
var hIT=_mz(z,'van-icon',['class',20,'color',1,'name',2],[],oDT,bCT,gg)
_(cHT,hIT)
}
cHT.wxXCkey=1
cHT.wxXCkey=3
...
tAT.wxXCkey=4
_2z(z,13,eBT,e,s,gg,tAT,'item','index','value')
var oJT=_n('slot')
_(a0S,oJT)
_(l9S,a0S)
}
