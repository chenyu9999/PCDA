...
var eN2B=_v()
_(r,eN2B)
if(_oz(z,0,e,s,gg)){eN2B.wxVkey=1
var bO2B=_n('view')
_rz(z,bO2B,'class',1,e,s,gg)
var oP2B=_oz(z,2,e,s,gg)
_(bO2B,oP2B)
_(eN2B,bO2B)
}
var xQ2B=_n('view')
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/cell-group/index.wxml'] = [$gwx_XC_64, './miniprogram_npm/@vant/weapp/cell-group/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/cell-group/index.wxml'] = $gwx_XC_64( './miniprogram_npm/@vant/weapp/cell-group/index.wxml' );
