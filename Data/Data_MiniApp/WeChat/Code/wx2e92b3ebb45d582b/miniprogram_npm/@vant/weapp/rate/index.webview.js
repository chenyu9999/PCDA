...
var oDCC=_mz(z,'view',['bind:touchmove',0,'class',1],[],e,s,gg)
var cECC=_v()
_(oDCC,cECC)
var oFCC=function(aHCC,lGCC,tICC,gg){
var bKCC=_mz(z,'view',['class',4,'style',1],[],aHCC,lGCC,gg)
var xMCC=_mz(z,'van-icon',['bind:click',6,'class',1,'color',2,'customClass',3,'data-score',4,'name',5,'style',6],[],aHCC,lGCC,gg)
_(bKCC,xMCC)
var oLCC=_v()
_(bKCC,oLCC)
if(_oz(z,13,aHCC,lGCC,gg)){oLCC.wxVkey=1
var oNCC=_mz(z,'van-icon',['bind:click',14,'class',1,'color',2,'customClass',3,'data-score',4,'name',5,'style',6],[],aHCC,lGCC,gg)
_(oLCC,oNCC)
}
oLCC.wxXCkey=1
oLCC.wxXCkey=3
...
cECC.wxXCkey=4
_2z(z,2,oFCC,e,s,gg,cECC,'item','index','index')
_(r,oDCC)
return r
}
