...
var tSGC=_n('slot')
_rz(z,tSGC,'name',1,e,s,gg)
_(lQGC,tSGC)
var eTGC=_n('view')
_rz(z,eTGC,'class',2,e,s,gg)
var bUGC=_v()
_(eTGC,bUGC)
if(_oz(z,3,e,s,gg)){bUGC.wxVkey=1
var xWGC=_mz(z,'van-icon',['customClass',4,'name',1,'size',2],[],e,s,gg)
_(bUGC,xWGC)
}
var oVGC=_v()
_(eTGC,oVGC)
if(_oz(z,7,e,s,gg)){oVGC.wxVkey=1
var oXGC=_n('view')
_rz(z,oXGC,'class',8,e,s,gg)
var fYGC=_oz(z,9,e,s,gg)
_(oXGC,fYGC)
_(oVGC,oXGC)
}
var cZGC=_n('slot')
_rz(z,cZGC,'name',10,e,s,gg)
_(eTGC,cZGC)
bUGC.wxXCkey=1
bUGC.wxXCkey=3
oVGC.wxXCkey=1
...
var o2GC=_v()
_(h1GC,o2GC)
if(_oz(z,12,e,s,gg)){o2GC.wxVkey=1
var o4GC=_n('view')
_rz(z,o4GC,'class',13,e,s,gg)
var l5GC=_n('text')
...
var b9GC=_oz(z,17,e,s,gg)
_(e8GC,b9GC)
_(t7GC,e8GC)
var o0GC=_n('text')
_rz(z,o0GC,'class',18,e,s,gg)
var xAHC=_oz(z,19,e,s,gg)
_(o0GC,xAHC)
_(t7GC,o0GC)
var oBHC=_n('text')
...
_(o4GC,t7GC)
var cDHC=_n('text')
_rz(z,cDHC,'class',21,e,s,gg)
var hEHC=_oz(z,22,e,s,gg)
_(cDHC,hEHC)
_(o4GC,cDHC)
_(o2GC,o4GC)
}
var oFHC=_mz(z,'van-button',['round',-1,'bind:click',23,'class',1,'customClass',2,'customStyle',3,'disabled',4,'loading',5,'type',6],[],e,s,gg)
var cGHC=_oz(z,30,e,s,gg)
_(oFHC,cGHC)
_(h1GC,oFHC)
o2GC.wxXCkey=1
_(lQGC,h1GC)
var aRGC=_v()
_(lQGC,aRGC)
if(_oz(z,31,e,s,gg)){aRGC.wxVkey=1
var oHHC=_n('view')
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_115();
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/submit-bar/index.wxml'] = [$gwx_XC_115, './miniprogram_npm/@vant/weapp/submit-bar/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/submit-bar/index.wxml'] = $gwx_XC_115( './miniprogram_npm/@vant/weapp/submit-bar/index.wxml' );
