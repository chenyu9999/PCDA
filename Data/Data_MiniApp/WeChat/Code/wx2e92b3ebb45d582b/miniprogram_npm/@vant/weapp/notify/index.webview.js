...
var l50B=_mz(z,'van-transition',['bind:tap',0,'customClass',1,'customStyle',1,'name',2,'show',3],[],e,s,gg)
var a60B=_mz(z,'view',['class',5,'style',1],[],e,s,gg)
var t70B=_v()
_(a60B,t70B)
if(_oz(z,7,e,s,gg)){t70B.wxVkey=1
var e80B=_n('view')
_rz(z,e80B,'style',8,e,s,gg)
_(t70B,e80B)
}
var b90B=_n('text')
var o00B=_oz(z,9,e,s,gg)
_(b90B,o00B)
_(a60B,b90B)
t70B.wxXCkey=1
_(l50B,a60B)
...
return root;
	...
	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/notify/index.wxml'] = [$gwx_XC_94, './miniprogram_npm/@vant/weapp/notify/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/notify/index.wxml'] = $gwx_XC_94( './miniprogram_npm/@vant/weapp/notify/index.wxml' );
