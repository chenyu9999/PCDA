...
var xQO=_mz(z,'van-icon',['bind:click',10,'customClass',1,'name',2],[],e,s,gg)
_(tMO,xQO)
}
var eNO=_v()
_(aLO,eNO)
...
var bOO=_v()
_(aLO,bOO)
if(_oz(z,14,e,s,gg)){bOO.wxVkey=1
var oRO=_v()
_(bOO,oRO)
var fSO=function(hUO,cTO,oVO,gg){
var oXO=_mz(z,'button',['appParameter',17,'bindcontact',1,'binderror',2,'bindgetphonenumber',3,'bindgetuserinfo',4,'bindlaunchapp',5,'bindopensetting',6,'bindtap',7,'class',8,'data-index',9,'hoverClass',10,'lang',11,'openType',12,'sendMessageImg',13,'sendMessagePath',14,'sendMessageTitle',15,'sessionFrom',16,'showMessageCard',17,'style',18],[],hUO,cTO,gg)
var lYO=_v()
_(oXO,lYO)
if(_oz(z,36,hUO,cTO,gg)){lYO.wxVkey=1
var aZO=_v()
_(lYO,aZO)
if(_oz(z,37,hUO,cTO,gg)){aZO.wxVkey=1
}
aZO.wxXCkey=1
}
else{lYO.wxVkey=2
var t1O=_mz(z,'van-loading',['customClass',38,'size',1],[],hUO,cTO,gg)
_(lYO,t1O)
}
lYO.wxXCkey=1
lYO.wxXCkey=3
...
oRO.wxXCkey=4
_2z(z,15,fSO,e,s,gg,oRO,'item','index','index')
}
var e2O=_n('slot')
_(aLO,e2O)
var oPO=_v()
_(aLO,oPO)
if(_oz(z,40,e,s,gg)){oPO.wxVkey=1
}
tMO.wxXCkey=1
tMO.wxXCkey=3
eNO.wxXCkey=1
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_57();	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/action-sheet/index.wxml'] = [$gwx_XC_57, './miniprogram_npm/@vant/weapp/action-sheet/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/action-sheet/index.wxml'] = $gwx_XC_57( './miniprogram_npm/@vant/weapp/action-sheet/index.wxml' );
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("../common/component"),t=require("../mixins/button");(0,e.VantComponent)({mixins:[t.button],props:{show:Boolean,title:String,cancelText:String,description:String,round:{type:Boolean,value:!0},zIndex:{type:Number,value:100},actions:{type:Array,value:[]},overlay:{type:Boolean,value:!0},closeOnClickOverlay:{type:Boolean,value:!0},closeOnClickAction:{type:Boolean,value:!0},safeAreaInsetBottom:{type:Boolean,value:!0}},methods:{onSelect:function(e){var t=this,o=e.currentTarget.dataset.index,n=this.data,i=n.actions,l=n.closeOnClickAction,s=n.canIUseGetUserProfile,c=i[o];c&&(this.$emit("select",c),l&&this.onClose(),"getUserInfo"===c.openType&&s&&wx.getUserProfile({desc:c.getUserProfileDesc||"  ",complete:function(e){t.$emit("getuserinfo",e)}}))},onCancel:function(){this.$emit("cancel")},onClose:function(){this.$emit("close")},onClickOverlay:function(){this.$emit("click-overlay"),this.onClose()}}});
},{isPage:false,isComponent:true,currentFile:'miniprogram_npm/@vant/weapp/action-sheet/index.js'});require("miniprogram_npm/@vant/weapp/action-sheet/index.js");