...
var oRZ=_mz(z,'view',['bind:tap',0,'class',1,'hoverClass',1,'hoverStayTime',2],[],e,s,gg)
var cSZ=_n('view')
_rz(z,cSZ,'class',4,e,s,gg)
var oTZ=_v()
_(cSZ,oTZ)
if(_oz(z,5,e,s,gg)){oTZ.wxVkey=1
var aVZ=_mz(z,'van-info',['dot',6,'info',1],[],e,s,gg)
_(oTZ,aVZ)
}
var lUZ=_v()
_(cSZ,lUZ)
if(_oz(z,8,e,s,gg)){lUZ.wxVkey=1
}
else{lUZ.wxVkey=2
var tWZ=_n('slot')
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_79();	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram_npm/@vant/weapp/sidebar-item/index.wxml'] = [$gwx_XC_79, './miniprogram_npm/@vant/weapp/sidebar-item/index.wxml'];else __wxAppCode__['miniprogram_npm/@vant/weapp/sidebar-item/index.wxml'] = $gwx_XC_79( './miniprogram_npm/@vant/weapp/sidebar-item/index.wxml' );
...
},{isPage:false,isComponent:true,currentFile:'miniprogram_npm/@vant/weapp/sidebar-item/index.js'});require("miniprogram_npm/@vant/weapp/sidebar-item/index.js");