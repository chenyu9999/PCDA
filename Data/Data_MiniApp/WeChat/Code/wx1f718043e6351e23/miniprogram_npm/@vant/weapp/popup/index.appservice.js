...
var b7Y=e_[x[0]].i
_ai(b7Y,x[1],e_,x[0],3,2)
var o8Y=_v()
_(r,o8Y)
if(_oz(z,0,e,s,gg)){o8Y.wxVkey=1
var o0Y=_mz(z,'van-overlay',['bind:click',1,'customStyle',1,'duration',2,'lockScroll',3,'rootPortal',4,'show',5,'zIndex',6],[],e,s,gg)
_(o8Y,o0Y)
}
var x9Y=_v()
_(r,x9Y)
...
},{isPage:false,isComponent:true,currentFile:'miniprogram_npm/@vant/weapp/popup/index.js'});require("miniprogram_npm/@vant/weapp/popup/index.js");