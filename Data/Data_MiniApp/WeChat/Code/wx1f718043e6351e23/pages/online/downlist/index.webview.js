...
var xKZC=_n('view')
var oLZC=_n('header')
_rz(z,oLZC,'title',0,e,s,gg)
_(xKZC,oLZC)
var fMZC=_n('view')
_rz(z,fMZC,'class',1,e,s,gg)
var cNZC=_n('home-custom-cases')
_rz(z,cNZC,'list',2,e,s,gg)
_(fMZC,cNZC)
_(xKZC,fMZC)
_(r,xKZC)
return r
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/online/downlist/index.wxss'] = setCssToHead([".",[1],"downlist{margin-top:",[0,20],"}\n",],undefined,{path:"./pages/online/downlist/index.wxss"});
}