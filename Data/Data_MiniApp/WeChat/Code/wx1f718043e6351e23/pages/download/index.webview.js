...
var aXHC=_mz(z,'header',['isFullPage',1,'isPlaceholder',1,'title',2],[],e,s,gg)
var tYHC=_n('view')
_rz(z,tYHC,'class',4,e,s,gg)
var eZHC=_v()
_(tYHC,eZHC)
if(_oz(z,5,e,s,gg)){eZHC.wxVkey=1
var b1HC=_n('view')
_rz(z,b1HC,'class',6,e,s,gg)
var o2HC=_n('download')
_rz(z,o2HC,'info',7,e,s,gg)
_(b1HC,o2HC)
_(eZHC,b1HC)
}
else{eZHC.wxVkey=2
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/download/index.wxss'] = setCssToHead([".",[1],"download-container{height:100%;padding:",[0,60]," ",[0,30]," 0}\n.",[1],"download-inner{background:#fff;box-shadow:0 ",[0,6]," ",[0,15]," rgba(0,0,0,.06);height:100%}\n",],undefined,{path:"./pages/download/index.wxss"});
}