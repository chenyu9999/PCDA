...
var c6HC=_mz(z,'header',['onlyTitle',0,'title',1],[],e,s,gg)
_(r,c6HC)
var h7HC=_n('view')
_rz(z,h7HC,'class',2,e,s,gg)
var o8HC=_v()
_(h7HC,o8HC)
if(_oz(z,3,e,s,gg)){o8HC.wxVkey=1
var c9HC=_n('view')
var o0HC=_mz(z,'image',['class',4,'mode',1,'src',2],[],e,s,gg)
_(c9HC,o0HC)
var lAIC=_n('view')
_rz(z,lAIC,'class',7,e,s,gg)
var aBIC=_oz(z,8,e,s,gg)
_(lAIC,aBIC)
_(c9HC,lAIC)
var tCIC=_n('view')
_rz(z,tCIC,'class',9,e,s,gg)
var eDIC=_mz(z,'form-box',['bind:doRequest',10,'bind:formSubmit',1,'bind:getOption',2,'bind:initOption',3,'bind:sendCode',4,'footer',5,'formConf',6,'privacy',7],[],e,s,gg)
_(tCIC,eDIC)
_(c9HC,tCIC)
_(o8HC,c9HC)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/form/activity/index.wxss'] = setCssToHead([".",[1],"form-panel{padding:",[0,30]," ",[0,30]," ",[0,120],"}\n.",[1],"form-banner{display:block;height:",[0,240],";width:100%}\n.",[1],"form-desc{color:#888;font-size:",[0,24],";padding:",[0,20]," ",[0,30]," ",[0,10],";text-align:center}\n",],undefined,{path:"./pages/form/activity/index.wxss"});
}