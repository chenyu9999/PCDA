...
var xGIC=_mz(z,'header',['onlyTitle',0,'title',1],[],e,s,gg)
_(r,xGIC)
var oHIC=_n('view')
_rz(z,oHIC,'class',2,e,s,gg)
var fIIC=_v()
_(oHIC,fIIC)
if(_oz(z,3,e,s,gg)){fIIC.wxVkey=1
var cJIC=_n('view')
var hKIC=_mz(z,'image',['class',4,'mode',1,'src',2],[],e,s,gg)
_(cJIC,hKIC)
var oLIC=_n('view')
...
var lOIC=_mz(z,'form-box',['bind:doRequest',10,'bind:formSubmit',1,'bind:getOption',2,'bind:initOption',3,'bind:sendCode',4,'footer',5,'formConf',6,'privacy',7],[],e,s,gg)
_(oNIC,lOIC)
_(cJIC,oNIC)
_(fIIC,cJIC)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/form/index/index.wxss'] = setCssToHead([".",[1],"form-panel{padding:",[0,30]," ",[0,30]," ",[0,120],"}\n.",[1],"form-banner{display:block;height:",[0,240],";width:100%}\n.",[1],"form-desc{color:#888;font-size:",[0,24],";padding:",[0,20]," ",[0,30]," ",[0,10],";text-align:center}\n",],undefined,{path:"./pages/form/index/index.wxss"});
}