...
Z([[7],[3,'multiIndex']])
Z([[7],[3,'showValue']])
Z([3,'form-picker-value'])
Z([a,[[7],[3,'showValue']]])
Z([3,'form-placeholder'])
Z([a,[[7],[3,'placeholder']]])
Z([3,'form-control-icon'])
Z([3,'aspectFit'])
Z([3,'https://mkttencent-1256915710.file.myqcloud.com/saas/cloud-mini/img-icon/icon-arrow-down.png'])
...
var a0L=_mz(z,'picker',['bindchange',0,'bindcolumnchange',1,'class',1,'mode',2,'range',3,'value',4],[],e,s,gg)
var tAM=_v()
_(a0L,tAM)
if(_oz(z,6,e,s,gg)){tAM.wxVkey=1
var eBM=_n('view')
_rz(z,eBM,'class',7,e,s,gg)
...
tAM.wxXCkey=1
_(r,a0L)
var oFM=_mz(z,'image',['class',11,'mode',1,'src',2],[],e,s,gg)
_(r,oFM)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/form-box/region/index.wxss'] = setCssToHead([".",[1],"form-picker-value,.",[1],"form-placeholder{-webkit-align-items:center;align-items:center;display:-webkit-flex;display:flex;font-size:",[0,24],";height:",[0,75],"}\n.",[1],"form-placeholder{color:#999;width:100%}\n.",[1],"form-control-icon{display:block;height:",[0,75],";pointer-events:none;position:absolute;right:0;top:0;width:",[0,75],"}\n",],undefined,{path:"./components/form-box/region/index.wxss"});
}