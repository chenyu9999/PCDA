...
var cHM=_mz(z,'switch',['bindchange',0,'checked',1,'class',1,'type',2],[],e,s,gg)
_(r,cHM)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/form-box/switch/index.wxss'] = setCssToHead([".",[1],"form-switch-input{float:right;font-size:0}\n",],undefined,{path:"./components/form-box/switch/index.wxss"});
}