...
var oZL=_mz(z,'input',['bindinput',0,'class',1,'confirmType',1,'maxlength',2,'placeholder',3,'placeholderClass',4,'type',5,'value',6],[],e,s,gg)
_(r,oZL)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/form-box/input/index.wxss'] = setCssToHead([],undefined,{path:"./components/form-box/input/index.wxss"});
}