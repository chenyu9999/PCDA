...
Z([a,[3,' '],[[7],[3,'dateString']],[3,' ']])
Z([3,'form-placeholder'])
Z([a,z[9][1],[[7],[3,'placeholder']],z[9][1]])
...
var tEI=_mz(z,'picker',['bindcancel',0,'bindchange',1,'bindcolumnchange',1,'mode',2,'range',3,'rangeKey',4,'value',5],[],e,s,gg)
var eFI=_v()
_(tEI,eFI)
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/form-box/date/index.wxss'] = setCssToHead([".",[1],"form-placeholder{color:#999;width:100%}\n.",[1],"form-picker-value,.",[1],"form-placeholder{-webkit-align-items:center;align-items:center;display:-webkit-flex;display:flex;font-size:",[0,24],";height:",[0,75],"}\n",],undefined,{path:"./components/form-box/date/index.wxss"});
}