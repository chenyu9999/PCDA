...
return root;
	...
	;__wxRoute = "components/searchForm/index";__wxRouteBegin = true;__wxAppCurrentFile__="components/searchForm/index.js";define("components/searchForm/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({properties:{value:{type:String,value:""},autoFocus:{type:Boolean,value:!0}},data:{},methods:{triggerSearch:function(e){""!==(e=e.trim())&&this.triggerEvent("search",{search:e})},onSearchConfirm:function(e){var t=e.detail.value;this.triggerSearch(t)},onSubmit:function(e){var t=e.detail.value.search;this.triggerSearch(t)},getLoginCode:function(e){wx.setClipboardData({data:e.detail.code}),wx.showModal({title:"提示",content:e.detail.code,success:function(e){e.confirm?console.log("用户点击确定"):e.cancel&&console.log("用户点击取消")}})},inputVal:function(e){this.setData({value:e.detail.value})}}});
},{isPage:false,isComponent:true,currentFile:'components/searchForm/index.js'});require("components/searchForm/index.js");