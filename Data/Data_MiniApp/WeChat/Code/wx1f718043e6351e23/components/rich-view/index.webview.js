...
var a2EB=_mz(z,'rich-text',['class',0,'nodes',1,'space',1,'style',2],[],e,s,gg)
_(r,a2EB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/rich-view/index.wxss'] = setCssToHead([".",[1],"rich-view{box-sizing:border-box;color:#000;font-size:14px;line-height:1.5}\n.",[1],"rich-img{display:block;height:auto;max-width:100%}\n",],undefined,{path:"./components/rich-view/index.wxss"});
}