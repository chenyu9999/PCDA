...
var bQ1=_n('view')
_rz(z,bQ1,'id',0,e,s,gg)
var oR1=e_[x[0]].i
_ai(oR1,x[1],e_,x[0],1,22)
var xS1=_v()
_(bQ1,xS1)
var oT1=_oz(z,1,e,s,gg)
var fU1=_gd(x[0],oT1,e_,d_)
if(fU1){
var cV1={}
...
return root;
	...
	;__wxRoute = "pages/verify-phone/verify-phone";__wxRouteBegin = true;__wxAppCurrentFile__="pages/verify-phone/verify-phone.js";define("pages/verify-phone/verify-phone.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/verify-phone/verify-phone.js'});require("pages/verify-phone/verify-phone.js");