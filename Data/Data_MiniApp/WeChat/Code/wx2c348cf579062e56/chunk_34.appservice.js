...
var lUS=_n('view')
_rz(z,lUS,'id',0,e,s,gg)
var aVS=e_[x[0]].i
_ai(aVS,x[1],e_,x[0],1,22)
var tWS=_v()
_(lUS,tWS)
var eXS=_oz(z,1,e,s,gg)
var bYS=_gd(x[0],eXS,e_,d_)
if(bYS){
var oZS={}
...
return root;
	...
	;__wxRoute = "pages/poi-comment/poi-comment";__wxRouteBegin = true;__wxAppCurrentFile__="pages/poi-comment/poi-comment.js";define("pages/poi-comment/poi-comment.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/poi-comment/poi-comment.js'});require("pages/poi-comment/poi-comment.js");