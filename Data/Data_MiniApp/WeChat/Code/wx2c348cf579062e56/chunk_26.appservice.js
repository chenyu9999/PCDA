...
var bSR=_n('view')
_rz(z,bSR,'id',0,e,s,gg)
var oTR=e_[x[0]].i
_ai(oTR,x[1],e_,x[0],1,22)
var xUR=_v()
_(bSR,xUR)
var oVR=_oz(z,1,e,s,gg)
var fWR=_gd(x[0],oVR,e_,d_)
if(fWR){
var cXR={}
...
return root;
	...
	;__wxRoute = "pages/my-coupons/my-coupons";__wxRouteBegin = true;__wxAppCurrentFile__="pages/my-coupons/my-coupons.js";define("pages/my-coupons/my-coupons.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/my-coupons/my-coupons.js'});require("pages/my-coupons/my-coupons.js");