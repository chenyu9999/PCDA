...
return root;
	...
	;__wxRoute = "pages/order-info/order-info";__wxRouteBegin = true;__wxAppCurrentFile__="pages/order-info/order-info.js";define("pages/order-info/order-info.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var r=require("../../npm/wmfe/wxapp-component-abtest0_4_4/src/components/abtest/index"),e=require("../../utils/redirParam");Page({onLoad:function(a){var o="A"===r.abtest.getCache("order-four-terminal-integration-test")?"/packages/trade/pages/order-info/index":"/packages/order/order-info/order-info";1===getApp().globalData.currentVersion?wx.redirectTo({url:"/packages/order/order-info-bargain/order-info?"+e(a)}):wx.redirectTo({url:o+"?"+e(a)})}});
},{isPage:true,isComponent:true,currentFile:'pages/order-info/order-info.js'});require("pages/order-info/order-info.js");