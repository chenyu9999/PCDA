...
return root;
	...
	;__wxRoute = "pages/city-select/city-select";__wxRouteBegin = true;__wxAppCurrentFile__="pages/city-select/city-select.js";define("pages/city-select/city-select.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../../utils/redirParam");Page({onLoad:function(r){wx.redirectTo({url:"/packages/loc/city-select/city-select?"+e(r)})}});
},{isPage:true,isComponent:true,currentFile:'pages/city-select/city-select.js'});require("pages/city-select/city-select.js");