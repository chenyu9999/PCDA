...
var l9Z=_n('view')
_rz(z,l9Z,'id',0,e,s,gg)
var a0Z=e_[x[0]].i
_ai(a0Z,x[1],e_,x[0],1,22)
var tA1=_v()
_(l9Z,tA1)
var eB1=_oz(z,1,e,s,gg)
var bC1=_gd(x[0],eB1,e_,d_)
if(bC1){
var oD1={}
...
return root;
	...
	;__wxRoute = "pages/refund-progress/refund-progress";__wxRouteBegin = true;__wxAppCurrentFile__="pages/refund-progress/refund-progress.js";define("pages/refund-progress/refund-progress.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/refund-progress/refund-progress.js'});require("pages/refund-progress/refund-progress.js");