...
return root;
	...
	;__wxRoute = "pages/order-info/order-info-map";__wxRouteBegin = true;__wxAppCurrentFile__="pages/order-info/order-info-map.js";define("pages/order-info/order-info-map.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var r=require("../../utils/redirParam");Page({onLoad:function(e){1===getApp().globalData.currentVersion?wx.redirectTo({url:"/packages/order/order-info-bargain/order-info-map?"+r(e)}):wx.redirectTo({url:"/packages/order/order-info/order-info-map?"+r(e)})}});
},{isPage:true,isComponent:true,currentFile:'pages/order-info/order-info-map.js'});require("pages/order-info/order-info-map.js");