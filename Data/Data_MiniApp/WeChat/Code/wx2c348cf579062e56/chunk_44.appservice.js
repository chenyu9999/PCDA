...
return root;
	...
	;__wxRoute = "pages/restaurant/restaurant";__wxRouteBegin = true;__wxAppCurrentFile__="pages/restaurant/restaurant.js";define("pages/restaurant/restaurant.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var r=require("../../utils/router"),a=require("../../utils/redirParam");Page({onLoad:function(e){var t=+new Date;r.navLog.start("restaurant"),wx.redirectTo({url:"/packages/restaurant/restaurant/restaurant?"+a(e)+"&cTime="+t})}});
},{isPage:true,isComponent:true,currentFile:'pages/restaurant/restaurant.js'});require("pages/restaurant/restaurant.js");