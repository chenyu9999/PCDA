...
return root;
	...
	;__wxRoute = "pages/external/poi";__wxRouteBegin = true;__wxAppCurrentFile__="pages/external/poi.js";define("pages/external/poi.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var r=require("../../utils/redirParam");Page({onLoad:function(e){wx.redirectTo({url:"/sub_inner_pages/external/poi?"+r(e)})}});
},{isPage:true,isComponent:true,currentFile:'pages/external/poi.js'});require("pages/external/poi.js");