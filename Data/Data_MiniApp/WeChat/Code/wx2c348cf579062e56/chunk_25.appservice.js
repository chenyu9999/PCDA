...
var oLR=_n('view')
_rz(z,oLR,'id',0,e,s,gg)
var cMR=e_[x[0]].i
_ai(cMR,x[1],e_,x[0],1,22)
var oNR=_v()
_(oLR,oNR)
var lOR=_oz(z,1,e,s,gg)
var aPR=_gd(x[0],lOR,e_,d_)
if(aPR){
var tQR={}
...
return root;
	...
	;__wxRoute = "pages/my-coupons-expired/my-coupons-expired";__wxRouteBegin = true;__wxAppCurrentFile__="pages/my-coupons-expired/my-coupons-expired.js";define("pages/my-coupons-expired/my-coupons-expired.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/my-coupons-expired/my-coupons-expired.js'});require("pages/my-coupons-expired/my-coupons-expired.js");