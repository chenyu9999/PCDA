...
var cES=e_[x[0]].i
_ai(cES,x[1],e_,x[0],1,22)
var oFS=_v()
_(oDS,oFS)
var lGS=_oz(z,1,e,s,gg)
var aHS=_gd(x[0],lGS,e_,d_)
if(aHS){
var tIS={}
...
return root;
	...
	;__wxRoute = "pages/non-delivery/non-delivery";__wxRouteBegin = true;__wxAppCurrentFile__="pages/non-delivery/non-delivery.js";define("pages/non-delivery/non-delivery.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/non-delivery/non-delivery.js'});require("pages/non-delivery/non-delivery.js");