...
return root;
	...
	;__wxRoute = "pages/loginV2/login";__wxRouteBegin = true;__wxAppCurrentFile__="pages/loginV2/login.js";define("pages/loginV2/login.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../../npm/wmfe/mp-perf1_0_7/index"),i=require("../../components/login-sdkV2/index"),n=require("../../utils/mix"),o=require("../base"),t=getApp(),r={pageName:"login",data:{isAuthPage:!1},afterLoginAction:"",onLoad:function(e){var n=e.afterLoginAction;return this.loading(!1),this.afterLoginAction=n,t.isFromPreLoginPage=!0,i.loginPlugin.wxLogin({afterLoginAction:n})},onShow:function(){var e=getCurrentPages(),i=e[e.length-1],n=t.isFromEntryPage,o=void 0!==n&&n,r=i.options.needAuth;(void 0===r||!r)&&o&&wx.navigateBack()},onUnload:function(){delete t.isFromEntryPage,delete t.isFromPreLoginPage}};(0,e.page)(n(r,o));
},{isPage:true,isComponent:true,currentFile:'pages/loginV2/login.js'});require("pages/loginV2/login.js");