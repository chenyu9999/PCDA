...
return root;
	...
	;__wxRoute = "pages/loc-select/loc-select";__wxRouteBegin = true;__wxAppCurrentFile__="pages/loc-select/loc-select.js";define("pages/loc-select/loc-select.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../../utils/redirParam");Page({onLoad:function(r){wx.redirectTo({url:"/packages/loc/loc-select/loc-select?"+e(r)})}});
},{isPage:true,isComponent:true,currentFile:'pages/loc-select/loc-select.js'});require("pages/loc-select/loc-select.js");