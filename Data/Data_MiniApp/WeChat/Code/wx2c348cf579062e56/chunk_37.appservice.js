...
"use strict";var e=require("../../npm/wmfe/wxapp-component-abtest0_4_4/src/components/abtest/index"),r=require("../../utils/redirParam");Page({onLoad:function(t){var a=(e.abtest.getCache("mp_preview_module"),"preview");wx.redirectTo({url:"/packages/"+a+"/preview?"+r(t)})}});
},{isPage:true,isComponent:true,currentFile:'pages/preview/preview.js'});require("pages/preview/preview.js");