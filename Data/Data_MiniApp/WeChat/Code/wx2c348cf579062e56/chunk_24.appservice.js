...
var bER=_n('view')
_rz(z,bER,'id',0,e,s,gg)
var oFR=e_[x[0]].i
_ai(oFR,x[1],e_,x[0],1,22)
var xGR=_v()
_(bER,xGR)
var oHR=_oz(z,1,e,s,gg)
var fIR=_gd(x[0],oHR,e_,d_)
if(fIR){
var cJR={}
...
return root;
	...
	;__wxRoute = "pages/my-address/my-address";__wxRouteBegin = true;__wxAppCurrentFile__="pages/my-address/my-address.js";define("pages/my-address/my-address.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/my-address/my-address.js'});require("pages/my-address/my-address.js");