...
var fG1=e_[x[0]].i
_ai(fG1,x[1],e_,x[0],1,22)
var cH1=_v()
_(oF1,cH1)
var hI1=_oz(z,1,e,s,gg)
var oJ1=_gd(x[0],hI1,e_,d_)
if(oJ1){
var cK1={}
...
return root;
	...
	;__wxRoute = "pages/request-refund/request-refund";__wxRouteBegin = true;__wxAppCurrentFile__="pages/request-refund/request-refund.js";define("pages/request-refund/request-refund.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/request-refund/request-refund.js'});require("pages/request-refund/request-refund.js");