...
var eBT=_n('view')
_rz(z,eBT,'id',0,e,s,gg)
var bCT=e_[x[0]].i
_ai(bCT,x[1],e_,x[0],1,22)
var oDT=_v()
_(eBT,oDT)
var xET=_oz(z,1,e,s,gg)
var oFT=_gd(x[0],xET,e_,d_)
if(oFT){
var fGT={}
...
return root;
	...
	;__wxRoute = "pages/qualification/qualification";__wxRouteBegin = true;__wxAppCurrentFile__="pages/qualification/qualification.js";define("pages/qualification/qualification.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/qualification/qualification.js'});require("pages/qualification/qualification.js");