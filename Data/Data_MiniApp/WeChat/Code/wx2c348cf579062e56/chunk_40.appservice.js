...
var lUZ=_n('view')
_rz(z,lUZ,'id',0,e,s,gg)
var aVZ=e_[x[0]].i
_ai(aVZ,x[1],e_,x[0],1,22)
var tWZ=_v()
_(lUZ,tWZ)
var eXZ=_oz(z,1,e,s,gg)
var bYZ=_gd(x[0],eXZ,e_,d_)
if(bYZ){
var oZZ={}
...
return root;
	...
	;__wxRoute = "pages/refund-apply/refund-apply";__wxRouteBegin = true;__wxAppCurrentFile__="pages/refund-apply/refund-apply.js";define("pages/refund-apply/refund-apply.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("../../components/sub_inner_nav/index");Page({onLoad:function(){n()}});
},{isPage:true,isComponent:true,currentFile:'pages/refund-apply/refund-apply.js'});require("pages/refund-apply/refund-apply.js");