...
"use strict";getApp();Page({data:{},onShow:function(){var e=(new Date).getTime().toString(),o=getApp().globalData.loginUrl;console.log("loginUrl:",o);var t=encodeURIComponent(o+"/marketTodo/index?temp="+e);encodeURIComponent("http://0.0.0.0:8080/monitoringBroadcast?mediaId=210432531254116352&token=ae1201967eee421b819f3c6ffbe8e433&userCode=V98424&timeStr=1703740669557");wx.redirectTo({url:"/pages/webView/webView?jumpUrl=".concat(t)})}});
