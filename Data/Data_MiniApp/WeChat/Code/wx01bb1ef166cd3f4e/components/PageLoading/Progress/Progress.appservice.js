...
return root;
	...
	;__wxRoute = "components/PageLoading/Progress/Progress";__wxRouteBegin = true;__wxAppCurrentFile__="components/PageLoading/Progress/Progress.js";define("components/PageLoading/Progress/Progress.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({data:{loading:!0,index:0,tips:["小程序加载中","正在准备奖品设置","正在准备抽奖工具","正在呼叫老板开门","老板正在赶来","马上就加载好了","再等一下","长时间没有反应","请联系客服"]},methods:{play:function(){var t=this;this.setData({loading:!0}),this._player=setInterval((function(){t.setData({index:(t.data.index+1)%t.data.tips.length})}),3e3)}},attached:function(){this.play()},detached:function(){clearInterval(this._player)}});
},{isPage:false,isComponent:true,currentFile:'components/PageLoading/Progress/Progress.js'});require("components/PageLoading/Progress/Progress.js");