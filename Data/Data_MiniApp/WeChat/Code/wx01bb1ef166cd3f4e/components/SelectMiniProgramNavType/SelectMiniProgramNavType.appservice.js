...
return root;
	...
	;__wxRoute = "components/SelectMiniProgramNavType/SelectMiniProgramNavType";__wxRouteBegin = true;__wxAppCurrentFile__="components/SelectMiniProgramNavType/SelectMiniProgramNavType.js";define("components/SelectMiniProgramNavType/SelectMiniProgramNavType.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";(0,require("miniprogram-computed").ComponentWithComputed)({properties:{value:String},computed:{selectedIndex:function(e){return e.options.findIndex((function(t){return t.value===e.value}))}},data:{options:[{label:"使用小程序链接",value:"shortlink"},{label:"使用小程序路径",value:"path"}]},methods:{select:function(e){var t=e.currentTarget.dataset.value;this.triggerEvent("change",{value:t})}}});
},{isPage:false,isComponent:true,currentFile:'components/SelectMiniProgramNavType/SelectMiniProgramNavType.js'});require("components/SelectMiniProgramNavType/SelectMiniProgramNavType.js");