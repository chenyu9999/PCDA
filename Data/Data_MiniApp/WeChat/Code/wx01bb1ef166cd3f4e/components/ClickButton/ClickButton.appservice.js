...
var c8=_mz(z,'button',['appParameter',1,'bindcontact',1,'binderror',2,'bindgetphonenumber',3,'class',4,'hoverClass',5,'openType',6,'sendMessageImg',7,'sendMessagePath',8,'sendMessageTitle',9,'sessionFrom',10,'showMessageCard',11],[],e,s,gg)
var h9=_n('slot')
_(c8,h9)
_(f7,c8)
}
...
return root;
	...
	;__wxRoute = "components/ClickButton/ClickButton";__wxRouteBegin = true;__wxAppCurrentFile__="components/ClickButton/ClickButton.js";define("components/ClickButton/ClickButton.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({properties:{type:{type:String,value:"primary"},size:{type:String,value:""},disable:Boolean,openType:String,sessionFrom:String,sendMessageTitle:String,sendMessagePath:String,sendMessageImg:String,showMessageCard:Boolean,appParameter:String},methods:{onError:function(e){this.triggerEvent("error",e.detail)},onContact:function(e){this.triggerEvent("contact",e.detail)},onGetPhone:function(e){this.triggerEvent("getphonenumber",e.detail)}}});
},{isPage:false,isComponent:true,currentFile:'components/ClickButton/ClickButton.js'});require("components/ClickButton/ClickButton.js");