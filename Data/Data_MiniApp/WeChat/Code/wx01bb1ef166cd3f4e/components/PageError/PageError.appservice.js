...
return root;
	...
	;__wxRoute = "components/PageError/PageError";__wxRouteBegin = true;__wxAppCurrentFile__="components/PageError/PageError.js";define("components/PageError/PageError.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var t=require("miniprogram-computed"),r=0;(0,t.ComponentWithComputed)({properties:{error:String},computed:{isCustomMsg:function(t){return/^[\u4e00-\u9fa5\s，。]+$/.test(t.error)}},methods:{reload:function(){var t=Date.now();t-r>5e3&&(this.triggerEvent("reload"),r=t)},onTapIcon:function(){this.data.error&&wx.setClipboardData({data:this.data.error,success:function(){wx.showToast({title:"已复制出错原因，请联系客服",icon:"none"})}})}}});
},{isPage:false,isComponent:true,currentFile:'components/PageError/PageError.js'});require("components/PageError/PageError.js");