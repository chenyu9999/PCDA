...
"use strict";Component({externalClasses:["circle-class"],properties:{checked:Boolean,disabled:Boolean,icon:{type:String,value:"https://lucky-cdn.nocode.com/mina/lottery/icon-selected.svg"}}});
},{isPage:false,isComponent:true,currentFile:'components/Checkbox/Checkbox.js'});require("components/Checkbox/Checkbox.js");