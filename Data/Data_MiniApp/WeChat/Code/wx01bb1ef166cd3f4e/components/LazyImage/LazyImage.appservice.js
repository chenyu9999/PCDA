...
return root;
	...
	;__wxRoute = "components/LazyImage/LazyImage";__wxRouteBegin = true;__wxAppCurrentFile__="components/LazyImage/LazyImage.js";define("components/LazyImage/LazyImage.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({properties:{src:{type:String,value:""},styles:{type:String,value:""},mode:{type:String,value:"scaleToFill"},disableLazy:{type:Boolean,value:!1}},methods:{onLoad:function(e){this.triggerEvent("load",e.detail)},onError:function(e){this.triggerEvent("error",e.detail)}}});
},{isPage:false,isComponent:true,currentFile:'components/LazyImage/LazyImage.js'});require("components/LazyImage/LazyImage.js");