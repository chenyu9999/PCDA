...
return root;
	...
	;__wxRoute = "components/ImgTextInput/ImgTextInput";__wxRouteBegin = true;__wxAppCurrentFile__="components/ImgTextInput/ImgTextInput.js";define("components/ImgTextInput/ImgTextInput.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../../@babel/runtime/helpers/regeneratorRuntime"),n=require("../../@babel/runtime/helpers/asyncToGenerator"),t=require("./utils");Component({properties:{isEditting:Boolean,value:{type:String,observer:function(e,n){e!==n&&this.setData({innerValue:e})}},placeholder:{type:String,value:"请输入文字"},maxlength:{type:Number,value:140}},data:{innerValue:""},methods:{onInput:function(e){this.triggerEvent("change",e.detail.value)},onLineChange:function(r){return n(e().mark((function n(){return e().wrap((function(e){for(;;)switch(e.prev=e.next){case 0:24,r.detail.lineCount>5&&(0,t.minaScrollBy)(24,0);case 3:case"end":return e.stop()}}),n)})))()}}});
},{isPage:false,isComponent:true,currentFile:'components/ImgTextInput/ImgTextInput.js'});require("components/ImgTextInput/ImgTextInput.js");