...
return root;
	...
	;__wxRoute = "components/WxToast/WxToast";__wxRouteBegin = true;__wxAppCurrentFile__="components/WxToast/WxToast.js";define("components/WxToast/WxToast.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),Component({properties:{},data:{visible:!1,title:""},detached:function(){clearTimeout(this.timer)},methods:{show:function(t){var e=this;clearTimeout(this.timer),this.setData({title:t.title,visible:!0}),this.timer=setTimeout((function(){e.hide()}),t.duration||1500),wx.hideLoading()},hide:function(){clearTimeout(this.timer),this.setData({visible:!1})}}});
},{isPage:false,isComponent:true,currentFile:'components/WxToast/WxToast.js'});require("components/WxToast/WxToast.js");