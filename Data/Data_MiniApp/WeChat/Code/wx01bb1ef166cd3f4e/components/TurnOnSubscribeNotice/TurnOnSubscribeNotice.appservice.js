...
var tSI=_mz(z,'ConfirmDialog',['bind:click',0,'btns',1,'desc',1,'disableClose',2,'id',3,'showClose',4,'title',5],[],e,s,gg)
_(r,tSI)
return r
}
...
return root;
	...
	;__wxRoute = "components/TurnOnSubscribeNotice/TurnOnSubscribeNotice";__wxRouteBegin = true;__wxAppCurrentFile__="components/TurnOnSubscribeNotice/TurnOnSubscribeNotice.js";define("components/TurnOnSubscribeNotice/TurnOnSubscribeNotice.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var n=require("@/constant");Component({data:{subscribeBtns:n.subscribeBtns},methods:{show:function(){var n,t;null===(n=this.selectComponent("#subscribe-noti"))||void 0===n||null===(t=n.show)||void 0===t||t.call(n)},openSeting:function(n){var t;"open-setting"===(null===(t=n.detail)||void 0===t?void 0:t.id)&&wx.openSetting()}}});
},{isPage:false,isComponent:true,currentFile:'components/TurnOnSubscribeNotice/TurnOnSubscribeNotice.js'});require("components/TurnOnSubscribeNotice/TurnOnSubscribeNotice.js");