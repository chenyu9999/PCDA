...
else if(_oz(z,3,e,s,gg)){eLC.wxVkey=2
}
else{eLC.wxVkey=3
var bMC=_n('slot')
_rz(z,bMC,'name',4,e,s,gg)
_(eLC,bMC)
}
eLC.wxXCkey=1
_(aJC,tKC)
...
return root;
	...
	;__wxRoute = "components/HeaderContentLayout/HeaderContentLayout";__wxRouteBegin = true;__wxAppCurrentFile__="components/HeaderContentLayout/HeaderContentLayout.js";define("components/HeaderContentLayout/HeaderContentLayout.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({options:{multipleSlots:!0},externalClasses:["label-class","content-class","header-class"],properties:{label:String,link:String,url:String,labelColor:String},methods:{onClickNav:function(){this.triggerEvent("link")}}});
},{isPage:false,isComponent:true,currentFile:'components/HeaderContentLayout/HeaderContentLayout.js'});require("components/HeaderContentLayout/HeaderContentLayout.js");