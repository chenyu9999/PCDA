...
return root;
	...
	;__wxRoute = "components/Switch/Switch";__wxRouteBegin = true;__wxAppCurrentFile__="components/Switch/Switch.js";define("components/Switch/Switch.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("@/utils/tools");Component({properties:{disabled:Boolean,disabledMessage:String,checked:Boolean,type:String,color:{type:String,value:"#e2453a"}},methods:{onClick:function(t){var i=this.data,a=i.disabled,s=i.disabledMessage;if(a)return s&&(0,e.showToast)(s);this.triggerEvent("click",t.detail)},onChange:function(e){this.data.disabled||this.triggerEvent("change",e.detail)}}});
},{isPage:false,isComponent:true,currentFile:'components/Switch/Switch.js'});require("components/Switch/Switch.js");