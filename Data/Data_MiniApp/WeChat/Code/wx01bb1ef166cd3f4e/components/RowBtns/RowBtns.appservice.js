...
return root;
	...
	;__wxRoute = "components/RowBtns/RowBtns";__wxRouteBegin = true;__wxAppCurrentFile__="components/RowBtns/RowBtns.js";define("components/RowBtns/RowBtns.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";Component({properties:{list:{type:Array,observer:function(t){this.setData({target:t.find((function(t){return t.active}))})}}},data:{target:{}},methods:{onClick:function(t){this.triggerEvent("select",t.currentTarget.dataset.item)}}});
},{isPage:false,isComponent:true,currentFile:'components/RowBtns/RowBtns.js'});require("components/RowBtns/RowBtns.js");