...
return root;
	...
	;__wxRoute = "components/l-painter-text/l-painter-text";__wxRouteBegin = true;__wxAppCurrentFile__="components/l-painter-text/l-painter-text.js";define("components/l-painter-text/l-painter-text.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../common/relation.js"),t=require("../../common/vendor.js"),r={name:"lime-painter-text",mixins:[e.children("painter")],props:{uid:String,css:[String,Object],text:[String,Number],replace:Object},data:function(){return{type:"text",el:{css:{},text:null}}}},n=t._export_sfc(r,[["render",function(e,t,r,n,i,c){return{}}]]);wx.createComponent(n);
},{isPage:false,isComponent:true,currentFile:'components/l-painter-text/l-painter-text.js'});require("components/l-painter-text/l-painter-text.js");