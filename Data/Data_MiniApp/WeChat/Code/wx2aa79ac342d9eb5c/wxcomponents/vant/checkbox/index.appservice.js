...
var fOL=_mz(z,'view',['bindtap',2,'class',1],[],e,s,gg)
var cPL=_n('slot')
_(fOL,cPL)
_(xML,fOL)
}
var hQL=_mz(z,'view',['bindtap',4,'class',1],[],e,s,gg)
var oRL=_v()
_(hQL,oRL)
...
var oTL=_mz(z,'van-icon',['class',8,'customClass',1,'customStyle',2,'name',3,'size',4,'style',5],[],e,s,gg)
_(oRL,oTL)
}
oRL.wxXCkey=1
oRL.wxXCkey=3
...
var lUL=_mz(z,'view',['bindtap',15,'class',1],[],e,s,gg)
var aVL=_n('slot')
_(lUL,aVL)
_(oNL,lUL)
}
...
return root;
	...
	;__wxRoute = "wxcomponents/vant/checkbox/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/checkbox/index.js";define("wxcomponents/vant/checkbox/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
...
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/checkbox/index.js'});require("wxcomponents/vant/checkbox/index.js");