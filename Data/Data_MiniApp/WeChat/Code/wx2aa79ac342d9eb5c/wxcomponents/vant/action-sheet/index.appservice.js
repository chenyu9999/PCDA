...
var cWH=_mz(z,'van-popup',['bind:close',0,'closeOnClickOverlay',1,'customClass',1,'overlay',2,'position',3,'round',4,'safeAreaInsetBottom',5,'show',6,'zIndex',7],[],e,s,gg)
var oXH=_v()
_(cWH,oXH)
if(_oz(z,9,e,s,gg)){oXH.wxVkey=1
var e2H=_mz(z,'van-icon',['bind:click',10,'customClass',1,'name',2],[],e,s,gg)
_(oXH,e2H)
}
var lYH=_v()
_(cWH,lYH)
if(_oz(z,13,e,s,gg)){lYH.wxVkey=1
}
var aZH=_v()
_(cWH,aZH)
if(_oz(z,14,e,s,gg)){aZH.wxVkey=1
var b3H=_v()
_(aZH,b3H)
var o4H=function(o6H,x5H,f7H,gg){
var h9H=_mz(z,'button',['appParameter',17,'bindcontact',1,'binderror',2,'bindgetphonenumber',3,'bindgetuserinfo',4,'bindlaunchapp',5,'bindopensetting',6,'bindtap',7,'class',8,'data-index',9,'hoverClass',10,'lang',11,'openType',12,'sendMessageImg',13,'sendMessagePath',14,'sendMessageTitle',15,'sessionFrom',16,'showMessageCard',17,'style',18],[],o6H,x5H,gg)
var o0H=_v()
_(h9H,o0H)
if(_oz(z,36,o6H,x5H,gg)){o0H.wxVkey=1
var cAI=_v()
_(o0H,cAI)
if(_oz(z,37,o6H,x5H,gg)){cAI.wxVkey=1
}
cAI.wxXCkey=1
}
else{o0H.wxVkey=2
var oBI=_mz(z,'van-loading',['customClass',38,'size',1],[],o6H,x5H,gg)
_(o0H,oBI)
}
o0H.wxXCkey=1
o0H.wxXCkey=3
...
b3H.wxXCkey=4
_2z(z,15,o4H,e,s,gg,b3H,'item','index','index')
}
var lCI=_n('slot')
_(cWH,lCI)
var t1H=_v()
_(cWH,t1H)
if(_oz(z,40,e,s,gg)){t1H.wxVkey=1
}
oXH.wxXCkey=1
oXH.wxXCkey=3
lYH.wxXCkey=1
