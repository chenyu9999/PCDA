...
return root;
	...
	;__wxRoute = "wxcomponents/vant/divider/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/divider/index.js";define("wxcomponents/vant/divider/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";(0,require("../common/component").VantComponent)({props:{dashed:Boolean,hairline:Boolean,contentPosition:String,fontSize:String,borderColor:String,textColor:String,customStyle:String}});
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/divider/index.js'});require("wxcomponents/vant/divider/index.js");