...
var oHO=_mz(z,'van-icon',['class',22,'classPrefix',1,'color',2,'customClass',3,'dot',4,'info',5,'infoClass',6,'name',7,'size',8],[],e,s,gg)
_(hGO,oHO)
}
else{hGO.wxVkey=2
var cIO=_n('slot')
_rz(z,cIO,'name',31,e,s,gg)
_(hGO,cIO)
}
hGO.wxXCkey=1
hGO.wxXCkey=3
...
return root;
	...
	;__wxRoute = "wxcomponents/vant/goods-action-icon/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/goods-action-icon/index.js";define("wxcomponents/vant/goods-action-icon/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
...
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/goods-action-icon/index.js'});require("wxcomponents/vant/goods-action-icon/index.js");