...
var lWQ=e_[x[0]].i
_ai(lWQ,x[1],e_,x[0],1,1)
var aXQ=_v()
_(r,aXQ)
if(_oz(z,0,e,s,gg)){aXQ.wxVkey=1
var tYQ=e_[x[0]].j
_ic(x[1],e_,x[0],e,s,aXQ,gg);
tYQ.pop()
}
else{aXQ.wxVkey=2
var eZQ=e_[x[0]].j
...
return root;
	...
	;__wxRoute = "wxcomponents/vant/overlay/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/overlay/index.js";define("wxcomponents/vant/overlay/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";(0,require("../common/component").VantComponent)({props:{show:Boolean,customStyle:String,duration:{type:null,value:300},zIndex:{type:Number,value:1},lockScroll:{type:Boolean,value:!0},rootPortal:{type:Boolean,value:!1}},methods:{onClick:function(){this.$emit("click")},noop:function(){}}});
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/overlay/index.js'});require("wxcomponents/vant/overlay/index.js");