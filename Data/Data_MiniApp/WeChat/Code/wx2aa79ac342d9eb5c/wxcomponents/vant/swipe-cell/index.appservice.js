...
var xQV=_mz(z,'view',['bindtouchcancel',0,'bindtouchend',1,'bindtouchstart',1,'capture-bind:touchmove',2,'catchtap',3,'catchtouchmove',4,'class',5,'data-key',6],[],e,s,gg)
var oRV=_n('view')
_rz(z,oRV,'style',8,e,s,gg)
var fSV=_v()
_(oRV,fSV)
if(_oz(z,9,e,s,gg)){fSV.wxVkey=1
var hUV=_mz(z,'view',['catch:tap',10,'class',1,'data-key',2],[],e,s,gg)
var oVV=_n('slot')
...
var cTV=_v()
_(oRV,cTV)
if(_oz(z,14,e,s,gg)){cTV.wxVkey=1
var oXV=_mz(z,'view',['catch:tap',15,'class',1,'data-key',2],[],e,s,gg)
var lYV=_n('slot')
_rz(z,lYV,'name',18,e,s,gg)
_(oXV,lYV)
_(cTV,oXV)
}
fSV.wxXCkey=1
...
return root;
	...
	;__wxRoute = "wxcomponents/vant/swipe-cell/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/swipe-cell/index.js";define("wxcomponents/vant/swipe-cell/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
...
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/swipe-cell/index.js'});require("wxcomponents/vant/swipe-cell/index.js");