...
var h5L=_mz(z,'van-cell',['bind:click',1,'border',1,'class',2,'clickable',3,'customClass',4,'hoverClass',5,'icon',6,'isLink',7,'label',8,'rightIconClass',9,'size',10,'title',11,'titleClass',12,'value',13],[],e,s,gg)
var o6L=_mz(z,'slot',['name',15,'slot',1],[],e,s,gg)
_(h5L,o6L)
var c7L=_mz(z,'slot',['name',17,'slot',1],[],e,s,gg)
_(h5L,c7L)
var o8L=_n('slot')
_rz(z,o8L,'name',19,e,s,gg)
_(h5L,o8L)
var l9L=_mz(z,'slot',['name',20,'slot',1],[],e,s,gg)
_(h5L,l9L)
_(c4L,h5L)
var a0L=_n('slot')
_(c4L,a0L)
...
return root;
	...
	;__wxRoute = "wxcomponents/vant/collapse-item/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/collapse-item/index.js";define("wxcomponents/vant/collapse-item/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../common/component"),t=require("../common/relation"),n=require("./animate");(0,e.VantComponent)({classes:["title-class","content-class"],relation:(0,t.useParent)("collapse"),props:{size:String,name:null,title:null,value:null,icon:String,label:String,disabled:Boolean,clickable:Boolean,border:{type:Boolean,value:!0},isLink:{type:Boolean,value:!0}},data:{expanded:!1},mounted:function(){this.updateExpanded(),this.mounted=!0},methods:{updateExpanded:function(){if(this.parent){var e=this.parent.data,t=e.value,a=e.accordion,i=this.parent.children,o=void 0===i?[]:i,s=this.data.name,d=o.indexOf(this),l=null==s?d:s,r=a?t===l:(t||[]).some((function(e){return e===l}));r!==this.data.expanded&&(0,n.setContentAnimate)(this,r,this.mounted),this.setData({index:d,expanded:r})}},onClick:function(){if(!this.data.disabled){var e=this.data,t=e.name,n=e.expanded,a=this.parent.children.indexOf(this),i=null==t?a:t;this.parent.switch(i,!n)}}}});
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/collapse-item/index.js'});require("wxcomponents/vant/collapse-item/index.js");