...
return root;
	...
	;__wxRoute = "wxcomponents/vant/config-provider/index";__wxRouteBegin = true;__wxAppCurrentFile__="wxcomponents/vant/config-provider/index.js";define("wxcomponents/vant/config-provider/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";(0,require("../common/component").VantComponent)({props:{themeVars:{type:Object,value:{}}}});
},{isPage:false,isComponent:true,currentFile:'wxcomponents/vant/config-provider/index.js'});require("wxcomponents/vant/config-provider/index.js");