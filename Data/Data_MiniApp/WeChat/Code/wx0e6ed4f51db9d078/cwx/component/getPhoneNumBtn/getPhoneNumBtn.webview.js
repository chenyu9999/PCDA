...
var c5N=_mz(z,'button',['bindgetphonenumber',0,'class',1,'disabled',1,'loading',2,'openType',3],[],e,s,gg)
var l7N=_n('slot')
_rz(z,l7N,'name',5,e,s,gg)
_(c5N,l7N)
var a8N=_n('text')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cwx/component/getPhoneNumBtn/getPhoneNumBtn.wxss'] = setCssToHead([],undefined,{path:"./cwx/component/getPhoneNumBtn/getPhoneNumBtn.wxss"});
}