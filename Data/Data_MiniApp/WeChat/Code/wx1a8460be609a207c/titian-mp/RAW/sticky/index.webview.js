...
Z([[7],[3,'usePureCss']])
Z([a,[3,'ext-class '],[[12],[[6],[[7],[3,'namespace']],[3,'join']],[[5],[1,'sticky']]]])
Z([3,'siyidx_1'])
Z([[12],[[6],[[7],[3,'utils']],[3,'setPureCss']],[[5],[[5],[[7],[3,'disabled']]],[[7],[3,'offsetTop']]]])
Z([a,z[1][1],z[1][2]])
Z([3,'siyidx_3'])
Z([a,[[12],[[6],[[7],[3,'utils']],[3,'outStyle']],[[5],[[5],[[5],[[7],[3,'fixed']]],[[7],[3,'width']]],[[7],[3,'height']]]],[3,';--sticky-z-index:'],[[7],[3,'zIndex']]])
Z([[12],[[6],[[7],[3,'namespace']],[3,'handle']],[[5],[[5],[1,'sticky']],[[8],'fixed',[[7],[3,'fixed']]]]])
Z([3,'siyidx_4'])
Z([[12],[[6],[[7],[3,'utils']],[3,'innerStyle']],[[5],[[5],[[7],[3,'fixed']]],[[7],[3,'offsetTop']]]])
...
var lUYB=_mz(z,'view',['class',1,'id',1,'style',2],[],e,s,gg)
var aVYB=_n('slot')
_(lUYB,aVYB)
_(oTYB,lUYB)
}
else{oTYB.wxVkey=2
var tWYB=_mz(z,'view',['class',4,'id',1,'style',2],[],e,s,gg)
var eXYB=_mz(z,'view',['class',7,'id',1,'style',2],[],e,s,gg)
var bYYB=_n('slot')
_(eXYB,bYYB)
_(tWYB,eXYB)
_(oTYB,tWYB)
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['titian-mp/RAW/sticky/index.wxss'] = setCssToHead([".",[1],"titian-sticky{position:relative;z-index:var(--sticky-z-index,99)}\n.",[1],"titian-sticky-fixed{left:var(--sticky-fixed-left,auto);position:fixed;top:0;width:var(--sticky-fixed-width,100%);z-index:var(--sticky-z-index,99)}\n",],undefined,{path:"./titian-mp/RAW/sticky/index.wxss"});
}