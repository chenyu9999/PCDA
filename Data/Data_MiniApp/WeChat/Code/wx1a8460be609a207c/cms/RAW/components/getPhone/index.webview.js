...
var z=gz$gwx_XC_6_1()
var c9C=_mz(z,'view',['class',0,'id',1],[],e,s,gg)
var o0C=_v()
_(c9C,o0C)
if(_oz(z,2,e,s,gg)){o0C.wxVkey=1
var lAD=_mz(z,'button',['bindgetphonenumber',3,'class',1,'id',2,'lang',3,'openType',4],[],e,s,gg)
var aBD=_n('slot')
_(lAD,aBD)
_(o0C,lAD)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cms/RAW/components/getPhone/index.wxss'] = setCssToHead([".",[1],"get-phone .",[1],"btn_mobile{background:transparent;border:none;border-radius:0;margin:0;padding:0}\n",],undefined,{path:"./cms/RAW/components/getPhone/index.wxss"});
}