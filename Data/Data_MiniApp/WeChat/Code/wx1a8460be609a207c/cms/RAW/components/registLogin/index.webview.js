...
var oFF=_mz(z,'realRegistLogin',['bind:attached',0,'id',1],[],e,s,gg)
_(r,oFF)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cms/RAW/components/registLogin/index.wxss'] = setCssToHead([[2,"./cms/RAW/styles/app.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./cms/RAW/components/registLogin/index.wxss:1:571)",{path:"./cms/RAW/components/registLogin/index.wxss"});
}