...
var fWD=_n('target-page')
_rz(z,fWD,'bind:titanpageattached',3,bSD,eRD,gg)
_(oVD,fWD)
}
oVD.wxXCkey=1
oVD.wxXCkey=3
...
aPD.wxXCkey=4
_2z(z,0,tQD,e,s,gg,aPD,'item','index','version')
var lOD=_v()
_(r,lOD)
...
return root;
	...
	;__wxRoute = "cms/new";__wxRouteBegin = true;__wxAppCurrentFile__="cms/new.js";define("cms/new.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";require("../@titan/env.js").createPageProxy("platform","cms",!1);
},{isPage:true,isComponent:true,currentFile:'cms/new.js'});require("cms/new.js");