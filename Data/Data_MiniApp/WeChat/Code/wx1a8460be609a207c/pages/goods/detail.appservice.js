...
var oV6=_v()
_(oT6,oV6)
if(_oz(z,2,bS6,eR6,gg)){oV6.wxVkey=1
var fW6=_n('target-page')
_rz(z,fW6,'bind:titanpageattached',3,bS6,eR6,gg)
_(oV6,fW6)
}
oV6.wxXCkey=1
oV6.wxXCkey=3
...
aP6.wxXCkey=4
_2z(z,0,tQ6,e,s,gg,aP6,'item','index','version')
var lO6=_v()
_(r,lO6)
...
return root;
	...
	;__wxRoute = "pages/goods/detail";__wxRouteBegin = true;__wxAppCurrentFile__="pages/goods/detail.js";define("pages/goods/detail.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";require("../../@titan/env.js").createPageProxy("platform","ec",!1);
},{isPage:true,isComponent:true,currentFile:'pages/goods/detail.js'});require("pages/goods/detail.js");