...
var x71=_v()
_(b51,x71)
if(_oz(z,2,e41,t31,gg)){x71.wxVkey=1
var o81=_n('target-page')
_rz(z,o81,'bind:titanpageattached',3,e41,t31,gg)
_(x71,o81)
}
x71.wxXCkey=1
x71.wxXCkey=3
...
l11.wxXCkey=4
_2z(z,0,a21,e,s,gg,l11,'item','index','version')
var oZ1=_v()
_(r,oZ1)
if(_oz(z,4,e,s,gg)){oZ1.wxVkey=1
}
oZ1.wxXCkey=1
return r
}
...
return root;
	...
	;__wxRoute = "cms_design/index";__wxRouteBegin = true;__wxAppCurrentFile__="cms_design/index.js";define("cms_design/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";require("../@titan/env.js").createPageProxy("package","cms_design",!1);
},{isPage:true,isComponent:true,currentFile:'cms_design/index.js'});require("cms_design/index.js");