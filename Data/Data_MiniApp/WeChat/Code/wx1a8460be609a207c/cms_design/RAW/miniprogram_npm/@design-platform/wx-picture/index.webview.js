...
var oT6=_mz(z,'picture-base',['bind:click',0,'exData',1,'from',1,'id',2,'moduleData',3],[],e,s,gg)
_(r,oT6)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cms_design/RAW/miniprogram_npm/@design-platform/wx-picture/index.wxss'] = setCssToHead([],undefined,{path:"./cms_design/RAW/miniprogram_npm/@design-platform/wx-picture/index.wxss"});
}