...
var cSZ=_mz(z,'CMSSDKImEntry',['bind:onCallback',1,'config',1,'extClass',2,'id',3],[],e,s,gg)
var oTZ=_n('slot')
_(cSZ,oTZ)
_(oRZ,cSZ)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cms_design/RAW/miniprogram_npm/@design-platform/wx-base-customer-service/index.wxss'] = setCssToHead([".",[1],"ext-button-style{border-radius:initial;display:block;vertical-align:middle;width:100%}\n",],undefined,{path:"./cms_design/RAW/miniprogram_npm/@design-platform/wx-base-customer-service/index.wxss"});
}