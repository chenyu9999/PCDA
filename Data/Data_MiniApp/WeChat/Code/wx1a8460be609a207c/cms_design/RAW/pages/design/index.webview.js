...
var oLEB=_mz(z,'titan-one-component',['d',0,'id',1,'s',1],[],e,s,gg)
var lMEB=_n('view')
_rz(z,lMEB,'id',3,e,s,gg)
var aNEB=_mz(z,'design-page',['bind:loadDataReady',4,'bind:pageReady',1,'bind:shareMessage',2,'id',3],[],e,s,gg)
_(lMEB,aNEB)
_(oLEB,lMEB)
var tOEB=_n('f_ec_couponPopup')
_rz(z,tOEB,'id',8,e,s,gg)
_(oLEB,tOEB)
_(r,oLEB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cms_design/RAW/pages/design/index.wxss'] = setCssToHead([[2,"./cms/RAW/styles/app.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./cms_design/RAW/pages/design/index.wxss:1:571)",{path:"./cms_design/RAW/pages/design/index.wxss"});
}