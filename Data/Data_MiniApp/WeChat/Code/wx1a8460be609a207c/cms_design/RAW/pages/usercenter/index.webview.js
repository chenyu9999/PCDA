...
var cVEB=_mz(z,'titan-one-component',['d',0,'id',1,'s',1],[],e,s,gg)
var hWEB=_n('view')
_rz(z,hWEB,'id',3,e,s,gg)
var oXEB=_mz(z,'design-page',['bind:loadDataReady',4,'bind:pageReady',1,'bind:shareMessage',2,'id',3,'isUserCenterPage',4],[],e,s,gg)
_(hWEB,oXEB)
_(cVEB,hWEB)
_(r,cVEB)
return r
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['cms_design/RAW/pages/usercenter/index.wxss'] = setCssToHead([[2,"./cms/RAW/styles/app.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./cms_design/RAW/pages/usercenter/index.wxss:1:571)",{path:"./cms_design/RAW/pages/usercenter/index.wxss"});
}