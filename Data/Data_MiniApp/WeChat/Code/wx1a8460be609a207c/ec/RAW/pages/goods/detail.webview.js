...
var lSMB=_mz(z,'titan-one-component',['d',0,'id',1,'s',1],[],e,s,gg)
var aTMB=_n('view')
_rz(z,aTMB,'id',3,e,s,gg)
_(lSMB,aTMB)
_(r,lSMB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['ec/RAW/pages/goods/detail.wxss'] = setCssToHead([],undefined,{path:"./ec/RAW/pages/goods/detail.wxss"});
}