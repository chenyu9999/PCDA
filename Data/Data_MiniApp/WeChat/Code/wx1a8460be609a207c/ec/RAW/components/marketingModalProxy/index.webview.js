...
var hOMB=_mz(z,'marketing-modal',['bind:closeModal',0,'id',1],[],e,s,gg)
_(r,hOMB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['ec/RAW/components/marketingModalProxy/index.wxss'] = setCssToHead([[2,"./ec/RAW/titan.component.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./ec/RAW/components/marketingModalProxy/index.wxss:1:10028)",{path:"./ec/RAW/components/marketingModalProxy/index.wxss"});
}