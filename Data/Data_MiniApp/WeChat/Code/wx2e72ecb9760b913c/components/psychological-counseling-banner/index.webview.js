...
Z([3,'psychological-counseling-banner'])
Z([[7],[3,'imgUrl']])
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/psychological-counseling-banner/index.wxss'] = setCssToHead([".",[1],"psychological-counseling-banner{-webkit-align-items:center;align-items:center;border-radius:",[0,8],";box-sizing:border-box;display:-webkit-flex;display:flex;height:",[0,172],";margin:",[0,22]," 0 ",[0,20]," ",[0,20],";width:",[0,710],"}\n.",[1],"psychological-counseling-banner wx-image{height:100%;width:100%}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./components/psychological-counseling-banner/index.wxss:1:242)",{path:"./components/psychological-counseling-banner/index.wxss"});
}