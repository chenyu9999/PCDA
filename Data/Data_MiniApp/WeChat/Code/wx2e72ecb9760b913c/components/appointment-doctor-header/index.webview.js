...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/appointment-doctor-header/index.wxss'] = setCssToHead([".",[1],"container{height:",[0,116],";padding:0 ",[0,40],"}\n.",[1],"container .",[1],"img{background:url(\x22https://staff.chunyu.mobi/@/media/images/2019/09/26/323a/46aa6861676c_w660_h70_.png\x22) no-repeat 50%;background-size:contain;height:100%}\n",],undefined,{path:"./components/appointment-doctor-header/index.wxss"});
}