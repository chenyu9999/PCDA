...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/bottom-next-step-button/index.wxss'] = setCssToHead([".",[1],"bottom-button-holder{background-color:#fff;bottom:0;box-shadow:0 0 5px 0 rgba(0,0,0,.08);box-sizing:border-box;left:0;padding:8px 15px ",[0,35],";position:fixed;width:100%}\n",],undefined,{path:"./components/bottom-next-step-button/index.wxss"});
}