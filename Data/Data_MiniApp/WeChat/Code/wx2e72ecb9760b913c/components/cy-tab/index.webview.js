...
Z([3,'label'])
Z([3,'tapItem'])
Z([a,[3,'tab-item '],[[2,'?:'],[[2,'==='],[[7],[3,'selectedIndex']],[[7],[3,'index']]],[1,'active'],[1,'']]])
Z([[7],[3,'index']])
Z([a,[3,'tab-item'],z[8]])
...
var t9G=_mz(z,'view',['class',1,'id',1,'style',2],[],e,s,gg)
_(a8G,t9G)
var e0G=_v()
_(a8G,e0G)
var bAH=function(xCH,oBH,oDH,gg){
var cFH=_mz(z,'view',['bindtap',6,'class',1,'data-index',2],[],xCH,oBH,gg)
var hGH=_n('text')
_rz(z,hGH,'id',9,xCH,oBH,gg)
var oHH=_oz(z,10,xCH,oBH,gg)
_(hGH,oHH)
_(cFH,hGH)
_(oDH,cFH)
return oDH
...
e0G.wxXCkey=2
_2z(z,4,bAH,e,s,gg,e0G,'item','index','label')
_(r,a8G)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/cy-tab/index.wxss'] = setCssToHead([".",[1],"switch-tab{background:#fff;border-bottom:",[0,1]," solid #f1f1f1;display:-webkit-flex;display:flex;line-height:",[0,60],";position:relative;text-align:center;width:100%;z-index:2}\n.",[1],"active-border{border-bottom:",[0,2]," solid #37cf6b;bottom:",[0,-1],";left:0;position:absolute;transition:all .3s}\n.",[1],"tab-item{color:#666;display:inline-block;-webkit-flex:1;flex:1;font-size:",[0,28],";height:",[0,90],";line-height:",[0,90],";transition:all .3s;width:20%}\n.",[1],"tab-item.",[1],"active{color:#37cf6b}\n",],undefined,{path:"./components/cy-tab/index.wxss"});
}