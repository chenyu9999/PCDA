...
Z([[7],[3,'hasFollowed']])
Z([3,'follow-component'])
Z([3,' 已关注\n'])
Z([3,'doFollowDoctor'])
Z(z[1])
Z([3,'icon-image'])
Z([3,'aspectFill'])
Z([3,'https://staff.chunyu.mobi/@/media/images/2023/03/02/e253/746f9841451e_w27_h27_.png'])
Z([3,'关注'])
...
var xET=_n('cy-userinfo')
_rz(z,xET,'bind:loginevent',3,e,s,gg)
var oFT=_n('view')
_rz(z,oFT,'class',4,e,s,gg)
var fGT=_mz(z,'image',['class',5,'mode',1,'src',2],[],e,s,gg)
_(oFT,fGT)
var cHT=_n('text')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/follow-doc-button/index.wxss'] = setCssToHead([".",[1],"follow-component{-webkit-align-items:center;align-items:center;background:#fff;border:",[0,2]," solid #39d167;border-radius:",[0,4],";color:#39d167;display:-webkit-flex;display:flex;font-size:",[0,28],";-webkit-justify-content:center;justify-content:center;margin:0;width:",[0,112],"}\n.",[1],"icon-image{display:block;height:",[0,20],";margin-right:",[0,10],";position:relative;top:",[0,-3],";width:",[0,20],"}\n",],undefined,{path:"./components/follow-doc-button/index.wxss"});
}