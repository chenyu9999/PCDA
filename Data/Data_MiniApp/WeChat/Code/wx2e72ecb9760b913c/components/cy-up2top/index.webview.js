...
Z([3,'upToTop'])
Z([3,'con'])
Z([3,'up-to-top position'])
Z([3,'https://staff.chunyu.mobi/@/media/images/2019/02/26/f506/911c317efbdd_w84_h82_.png'])
Z([3,'transform: translateX(4px) translateY(85px) translateZ(0px) scale(1);transform-origin: center center 0px;will-change: auto;'])
...
var o4H=_mz(z,'image',['bindtap',0,'bindtouchmove',1,'class',1,'src',2,'style',3],[],e,s,gg)
_(r,o4H)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/cy-up2top/index.wxss'] = setCssToHead([".",[1],"up-to-top{bottom:",[0,340],";height:",[0,82],";position:fixed;right:",[0,28],";width:",[0,82],"}\n",],undefined,{path:"./components/cy-up2top/index.wxss"});
}