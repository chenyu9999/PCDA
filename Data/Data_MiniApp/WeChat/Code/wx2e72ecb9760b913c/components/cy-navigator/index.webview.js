...
var tUG=_mz(z,'form',['reportSubmit',-1,'bindsubmit',0],[],e,s,gg)
var eVG=_mz(z,'button',['class',1,'formType',1],[],e,s,gg)
var bWG=_n('slot')
_(eVG,bWG)
_(tUG,eVG)
_(r,tUG)
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/cy-navigator/index.wxss'] = setCssToHead([".",[1],"cy-nav-btn{background:transparent;border-radius:0;color:inherit;font-size:inherit;height:100%;line-height:inherit;margin:0;overflow:visible;padding:0;text-align:inherit}\n",],undefined,{path:"./components/cy-navigator/index.wxss"});
}