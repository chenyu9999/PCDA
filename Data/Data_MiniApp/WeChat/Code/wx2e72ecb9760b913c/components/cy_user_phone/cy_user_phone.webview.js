...
var tCK=_mz(z,'button',['bindgetphonenumber',1,'class',1,'openType',2],[],e,s,gg)
var eDK=_n('slot')
_(tCK,eDK)
_(aBK,tCK)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/cy_user_phone/cy_user_phone.wxss'] = setCssToHead([".",[1],"remove-native-class{-webkit-tap-highlight-color:transparent;background-color:initial;border-radius:5px;box-sizing:border-box;color:#000;cursor:pointer;display:block;font-size:18px;height:100%;line-height:2.55555556;margin-left:auto;margin-right:auto;overflow:hidden;padding-left:0;padding-right:0;position:relative;text-align:center;text-decoration:none;width:100%}\n",],undefined,{path:"./components/cy_user_phone/cy_user_phone.wxss"});
}