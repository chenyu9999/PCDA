...
Z([a,[3,'top-pop '],[[2,'?:'],[[2,'=='],[[7],[3,'theme']],[1,'bg-white-color']],[1,'bg-white-color'],[1,'']]])
Z([3,'text'])
Z([3,'添加到我的小程序，方便查看咨询记录'])
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/cy-top-tip/index.wxss'] = setCssToHead([".",[1],"top-pop{background:#39d167;border-radius:5px;color:#fff;font-size:14px;line-height:1;margin:",[0,20],";padding:",[0,20]," ",[0,24],";position:fixed;right:0;top:0;z-index:111}\n.",[1],"top-pop::before{border:",[0,20]," solid transparent;border-bottom-color:#39d167;content:\x22\x22;display:inline-block;height:0;position:absolute;right:",[0,100],";top:",[0,-35],";width:0}\n.",[1],"bg-white-color{background:#fff;color:#39d167}\n.",[1],"bg-white-color::before{border-bottom:",[0,20]," solid #fff;content:\x22\x22}\n",],undefined,{path:"./components/cy-top-tip/index.wxss"});
}