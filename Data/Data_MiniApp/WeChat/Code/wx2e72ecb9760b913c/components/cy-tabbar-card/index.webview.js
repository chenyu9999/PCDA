...
Z([3,'tabbar-bubble'])
Z([a,[3,'background-image:url('],[[7],[3,'imageUrl']],[3,')']])
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/cy-tabbar-card/index.wxss'] = setCssToHead([".",[1],"tabbar-bubble{background-image:url(https://fqcz.w.eolink.com/assets/images/default_logo_female.jpg);background-position:bottom;background-repeat:no-repeat;background-size:auto 100%;bottom:0;height:",[0,64],";left:0;position:fixed;right:0;z-index:41}\n",],undefined,{path:"./components/cy-tabbar-card/index.wxss"});
}