...
Z([3,'new-user-welfare-bar-wrap add-fixed'])
Z([a,[3,'bottom: '],[[2,'?:'],[[7],[3,'bottomGroupHeight']],[[2,'+'],[[7],[3,'bottomGroupHeight']],[1,'px']],[1,'198rpx']]])
Z([3,'clickToJump'])
Z([3,'new-user-welfare-icon'])
Z([3,'widthFill'])
Z([[6],[[7],[3,'adDetail']],[3,'image']])
...
var cVT=_mz(z,'image',['bind:tap',2,'class',1,'mode',2,'src',3],[],e,s,gg)
_(fUT,cVT)
_(r,fUT)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['components/new_user_welfare_bar/index.wxss'] = setCssToHead([".",[1],"add-fixed{left:0;position:fixed;width:100%}\n.",[1],"new-user-welfare-bar-wrap{height:",[0,124],";width:100%}\n.",[1],"new-user-welfare-icon{display:block;height:100%;width:100%}\n",],undefined,{path:"./components/new_user_welfare_bar/index.wxss"});
}