...
var hMW=_mz(z,'view',['class',0,'style',1],[],e,s,gg)
var oNW=_v()
_(hMW,oNW)
if(_oz(z,2,e,s,gg)){oNW.wxVkey=1
var cOW=_n('slot')
_(oNW,cOW)
}
var oPW=_mz(z,'node',['catchadd',3,'childs',1,'id',2,'opts',3],[],e,s,gg)
_(hMW,oPW)
oNW.wxXCkey=1
_(r,hMW)
return r
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram_npm/mp-html/index.wxss'] = setCssToHead([".",[1],"_root{-webkit-overflow-scrolling:touch;overflow-x:auto;overflow-y:hidden;padding:1px 0}\n.",[1],"_select{-webkit-user-select:text;user-select:text}\n",],undefined,{path:"./miniprogram_npm/mp-html/index.wxss"});
}