...
var aH5C=_v()
_(r,aH5C)
if(_oz(z,0,e,s,gg)){aH5C.wxVkey=1
var tI5C=_n('view')
var eJ5C=_n('view')
_rz(z,eJ5C,'class',1,e,s,gg)
var bK5C=_n('view')
_rz(z,bK5C,'class',2,e,s,gg)
_(eJ5C,bK5C)
var oL5C=_n('view')
_rz(z,oL5C,'class',3,e,s,gg)
var xM5C=_oz(z,4,e,s,gg)
_(oL5C,xM5C)
_(eJ5C,oL5C)
_(tI5C,eJ5C)
_(aH5C,tI5C)
}
else if(_oz(z,5,e,s,gg)){aH5C.wxVkey=2
var oN5C=_n('view')
var fO5C=_mz(z,'web-view',['bindload',6,'src',1],[],e,s,gg)
_(oN5C,fO5C)
_(aH5C,oN5C)
}
else{aH5C.wxVkey=3
...
var hQ5C=_mz(z,'icon',['size',9,'type',1],[],e,s,gg)
_(cP5C,hQ5C)
var oR5C=_n('view')
_rz(z,oR5C,'class',11,e,s,gg)
var cS5C=_oz(z,12,e,s,gg)
_(oR5C,cS5C)
_(cP5C,oR5C)
_(aH5C,cP5C)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/free_clinic_webview/index.wxss'] = setCssToHead([".",[1],"tip{color:#888;font-size:12px;margin-top:150px;text-align:center}\n.",[1],"tip-desc{margin-top:16px}\n",],undefined,{path:"./pages/free_clinic_webview/index.wxss"});
}