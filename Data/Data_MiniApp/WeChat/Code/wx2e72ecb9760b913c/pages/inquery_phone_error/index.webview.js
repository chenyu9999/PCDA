$gwx_XC_153=function(_,_v,_n,_p,_s,_wp,_wl,$gwn,$gwl,$gwh,wh,$gstack,$gwrt,gra,grb,TestTest,wfor,_ca,_da,_r,_rz,_o,_oz,_1,_1z,_2,_2z,_m,_mz,nv_getDate,nv_getRegExp,nv_console,nv_parseInt,nv_parseFloat,nv_isNaN,nv_isFinite,nv_decodeURI,nv_decodeURIComponent,nv_encodeURI,nv_encodeURIComponent,$gdc,nv_JSON,_af,_gv,_ai,_grp,_gd,_gapi,$ixc,_ic,_w,_ev,_tsd){return function(path,global){
...
Z([3,'bg'])
Z([3,'widthFix'])
Z([3,'https://resource.chunyu.mobi/@/media/images/2022/07/29/ce37/e8b5483c511f_w1125_h3183_.png'])
Z([3,'toUserCenter'])
Z([3,'btn'])
Z(z[2])
Z([3,'https://resource.chunyu.mobi/@/media/images/2022/07/29/3d01/70ec383f2f50_w1125_h201_.png'])
...
var oVRE=_n('view')
_rz(z,oVRE,'class',0,e,s,gg)
var cWRE=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(oVRE,cWRE)
var oXRE=_mz(z,'image',['bindtap',4,'class',1,'mode',2,'src',3],[],e,s,gg)
_(oVRE,oXRE)
_(r,oVRE)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/inquery_phone_error/index.wxss'] = setCssToHead([".",[1],"wrapper{padding-bottom:",[0,95],"}\n.",[1],"bg,.",[1],"btn{height:100%;width:100%}\n.",[1],"btn{bottom:0;left:0;position:fixed}\n",],undefined,{path:"./pages/inquery_phone_error/index.wxss"});
}