...
Z([3,'live-official-account-main-container'])
Z([3,'qr-code'])
Z([3,'aspectFill'])
Z([[6],[[7],[3,'qrCodeMap']],[[7],[3,'currentUrlKey']]])
...
var oHSE=_n('view')
_rz(z,oHSE,'class',0,e,s,gg)
var xISE=_mz(z,'image',['showMenuByLongpress',-1,'class',1,'mode',1,'src',2],[],e,s,gg)
_(oHSE,xISE)
_(r,oHSE)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/live_official_account/live_official_account.wxss'] = setCssToHead([".",[1],"live-official-account-main-container{background-color:#dcf7f8;background-image:url(https://resource.chunyu.mobi/@/media/images/2022/11/24/bb81/25768c28d469_w512_h819_.png);background-repeat:no-repeat;background-size:contain;height:100vh;width:100%}\n.",[1],"qr-code{border-radius:",[0,8],";display:block;height:",[0,348],";left:50%;position:absolute;top:",[0,575],";-webkit-transform:translate(-50%,0);transform:translate(-50%,0);width:",[0,348],"}\n",],undefined,{path:"./pages/live_official_account/live_official_account.wxss"});
}