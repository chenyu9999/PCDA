...
var aBCB=_v()
_(r,aBCB)
if(_oz(z,0,e,s,gg)){aBCB.wxVkey=1
var tCCB=_mz(z,'cy-loading',['darkTheme',-1,'loading',1],[],e,s,gg)
_(aBCB,tCCB)
}
aBCB.wxXCkey=1
aBCB.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/baobei_payment/index.wxss'] = setCssToHead(["body{background:#f2f2f2;height:100%}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/baobei_payment/index.wxss:1:1)",{path:"./pages/baobei_payment/index.wxss"});
}