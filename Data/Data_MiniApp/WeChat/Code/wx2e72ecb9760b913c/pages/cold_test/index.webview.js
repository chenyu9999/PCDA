...
else if(_oz(z,5,e,s,gg)){aTFB.wxVkey=2
var oZFB=_n('view')
var f1FB=_mz(z,'web-view',['bindmessage',6,'src',1],[],e,s,gg)
_(oZFB,f1FB)
_(aTFB,oZFB)
}
else{aTFB.wxVkey=3
var c2FB=_n('view')
_rz(z,c2FB,'class',8,e,s,gg)
var h3FB=_mz(z,'icon',['size',9,'type',1],[],e,s,gg)
_(c2FB,h3FB)
var o4FB=_n('view')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/cold_test/index.wxss'] = setCssToHead([".",[1],"tip{color:#888;font-size:12px;margin-top:150px;text-align:center}\n.",[1],"tip-desc{margin-top:16px}\n",],undefined,{path:"./pages/cold_test/index.wxss"});
}