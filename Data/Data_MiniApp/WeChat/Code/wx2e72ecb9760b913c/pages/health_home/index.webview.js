...
var b9FD=_v()
_(r,b9FD)
if(_oz(z,0,e,s,gg)){b9FD.wxVkey=1
var o0FD=_n('view')
var xAGD=_n('view')
...
var cDGD=_oz(z,4,e,s,gg)
_(fCGD,cDGD)
_(xAGD,fCGD)
_(o0FD,xAGD)
_(b9FD,o0FD)
}
else if(_oz(z,5,e,s,gg)){b9FD.wxVkey=2
var hEGD=_n('view')
var oFGD=_n('web-view')
_rz(z,oFGD,'src',6,e,s,gg)
_(hEGD,oFGD)
_(b9FD,hEGD)
}
else{b9FD.wxVkey=3
var cGGD=_n('view')
_rz(z,cGGD,'class',7,e,s,gg)
var oHGD=_mz(z,'icon',['size',8,'type',1],[],e,s,gg)
_(cGGD,oHGD)
var lIGD=_n('view')
_rz(z,lIGD,'class',10,e,s,gg)
var aJGD=_oz(z,11,e,s,gg)
_(lIGD,aJGD)
_(cGGD,lIGD)
_(b9FD,cGGD)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/health_home/index.wxss'] = setCssToHead([".",[1],"tip{color:#888;font-size:12px;margin-top:150px;text-align:center}\n.",[1],"tip-desc{margin-top:16px}\n",],undefined,{path:"./pages/health_home/index.wxss"});
}