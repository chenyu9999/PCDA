...
var t9DD=_v()
_(r,t9DD)
if(_oz(z,0,e,s,gg)){t9DD.wxVkey=1
var e0DD=_n('view')
var bAED=_n('view')
...
_(bAED,oBED)
var xCED=_n('view')
_rz(z,xCED,'class',3,e,s,gg)
var oDED=_oz(z,4,e,s,gg)
_(xCED,oDED)
_(bAED,xCED)
_(e0DD,bAED)
_(t9DD,e0DD)
}
else if(_oz(z,5,e,s,gg)){t9DD.wxVkey=2
var fEED=_n('view')
var cFED=_mz(z,'web-view',['bindload',6,'bindmessage',1,'src',2],[],e,s,gg)
_(fEED,cFED)
_(t9DD,fEED)
}
else{t9DD.wxVkey=3
var hGED=_n('view')
_rz(z,hGED,'class',9,e,s,gg)
var oHED=_mz(z,'icon',['size',10,'type',1],[],e,s,gg)
_(hGED,oHED)
var cIED=_n('view')
_rz(z,cIED,'class',12,e,s,gg)
var oJED=_oz(z,13,e,s,gg)
_(cIED,oJED)
_(hGED,cIED)
_(t9DD,hGED)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/h5_webview/index.wxss'] = setCssToHead([".",[1],"tip{color:#888;font-size:12px;margin-top:150px;text-align:center}\n.",[1],"tip-desc{margin-top:16px}\n",],undefined,{path:"./pages/h5_webview/index.wxss"});
}