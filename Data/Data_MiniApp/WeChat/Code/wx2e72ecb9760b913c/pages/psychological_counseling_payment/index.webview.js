...
var l1AF=_v()
_(r,l1AF)
if(_oz(z,0,e,s,gg)){l1AF.wxVkey=1
var a2AF=_n('cy-authorize-login')
_rz(z,a2AF,'bindloginSuccess',1,e,s,gg)
_(l1AF,a2AF)
}
l1AF.wxXCkey=1
l1AF.wxXCkey=3
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/psychological_counseling_payment/index.wxss'] = setCssToHead(["body{background:#f2f2f2;height:100%}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/psychological_counseling_payment/index.wxss:1:1)",{path:"./pages/psychological_counseling_payment/index.wxss"});
}