...
var l3FF=_n('view')
_rz(z,l3FF,'class',0,e,s,gg)
var a4FF=_n('view')
_rz(z,a4FF,'bindtap',1,e,s,gg)
var t5FF=_n('rich-text')
_rz(z,t5FF,'nodes',2,e,s,gg)
_(a4FF,t5FF)
_(l3FF,a4FF)
_(r,l3FF)
return r
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/qa_im/components/link_notice_user/link_notice_user.wxss'] = setCssToHead([".",[1],"link-notice-user-wrap{background:#d4d4d4;border-radius:",[0,8],";color:#fff;font-size:14px;margin:",[0,0]," ",[0,120],";padding:0 ",[0,20],";text-align:center}\n",],undefined,{path:"./pages/qa_im/components/link_notice_user/link_notice_user.wxss"});
}